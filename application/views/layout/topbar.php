...
<div id='loadingDiv'
    style="display: cover; position: fixed;z-index: 1000;top: 0;left: 0;height: 100%;width: 100%;background: #026CB6;">
    <div
        style="display: cover; vertical-align: middle; z-index: 1000;top: 0;left: 0;height: 85px;width: 85px; border-radius: 100%; background: #fff url('https://rumahtinggal.id/assets/gif/rt-loader.gif') 50% 50% no-repeat;margin: 0 auto;margin-top: 23%;margin-bottom: 50%;">
...
<header id="header" class="header">
        ...
        <div class="row align-items-center d-flex">
            <nav class="navbar navbar-expand-custom navbar-mainbg navbar-fixed-top w-100 justify-content-between">
                <div class="col-md-7 justify-content-between" style="display: inline-flex;">
                    ...
                    <div class="input-group" id="logo-desk"
                        style="width: 500px;border-radius: 5px;border: 1px solid #e2e2e2;height: 37px;margin-top: 3px;">
                        <input type="text" class="form-control" id="cari-desain" placeholder="Rumah Minimalis"
                            style="padding:0px 15px;border:0px;font-weight: unset;">
                        <span class="input-group-btn">
                            <button type="submit" class="btn btn-default"
                                style="background-color: #026CB6;color:#fff;padding: 4px;border-radius: 0px 3px 3px 0px;">
                                <span class="glyphicon glyphicon-search" style="padding-left: 3px;"><i
                ...
                <div class="col-md-4" style="display: inline-flex;float: right;justify-content: end;">
                    ...
                    <div class="input-group" id="logo-mo"
                        style="width: 125px;border-radius: 5px;border: 1px solid #e2e2e2;display: none;">
                        <span class="input-group-btn">
                            <button type="submit" class="btn btn-default"
                                style="background-color: #fff;padding: 0px;border-radius: 3px 0px 0px 3px;">
                                <span class="glyphicon glyphicon-search" style="padding-left: 3px;"><i
                                        class="fa fa-search" aria-hidden="true"></i></span>
                            </button>
                        </span>
                        <input type="text" class="form-control" id="cari-desain" placeholder="cari desain"
                            style="padding:0px;border:0px;">
                    </div>

                    <nav id="nav-menu-container-dev" style="padding-right: 0; margin-left: 35px;">
                        <ul class="nav-menu">
                            <li class="menu-has-children" id="menu-login" style="display: none;"><a
                                    href="javascript:void(0)" data-toggle="modal" data-target="#ModalLogin"
                                    class="btn btn-custom login">Masuk</a></li>
                            <li class="dropdown" id="menu-pengguna" style="display: none;margin-top: -2px;">
                                ...
                                <div class="dropdown-content">
                                    <a href="javascript:void(0)" onclick="profil()"><i class="fa fa-user"
                                            style="font-size: 15px;margin-left: 2px;margin-right: 5px;"></i>Profil</a>
                                    <a href="javascript:void(0)" onclick="daftarFavorit()"><i class="fa fa-heart"></i>
                                        Daftar Favorit</a>
                                    <a href="javascript:void(0)" onclick="transaksiPembelian()"><i
                                            class="fa fa-shopping-bag"></i> Transaksi Pembelian</a>
                                    <a href="javascript:void(0)" onclick="logout()"><i class="fa fa-sign-out"
                                            style="font-size: 15px;margin-left: 1px;margin-right: 2px;"></i> Keluar</a>
                                </div>
                            </li>
                        </ul>
                    </nav>
                    <button class="btn btn-danger text-white ml-4" id="
                    -mo" onclick="assessment()"
                        style="padding: 2px 4px; margin-left: 0px;background: #f00;border-color: #f00; margin-top: 0px;font-size: 13px;position: absolute;top: 10px;left: 244px;display:none;">Cari
                        Desain</button>
                </div>
            </nav>
        </div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent"
        style="margin-top: 60px; width: 205px; position: fixed;z-index: 996;margin-left: 0px;">
        <ul class="navbar-nav ml-auto">
            <nav id="nav-menu-container" style="padding-right: 0;background: #030067;">
                <ul class="nav-menu">
                    ...
                    <li class="dropdown" id="menu-pengguna"
                        style="margin-top: -2px;background: transparent !important; margin-left: 5px;">
                        <button class="dropbtn" style="background: transparent;margin-left:0px !important"><span
                                style="color: #cadcff;margin-right: 70px;">Halo, <span id="nama_customer"
                                    style="color: #fff"></span></span></button>
                        <div class="dropdown-content" style="width: 205px;">
                            <a href="javascript:void(0)" onclick="profil()" style="color: #000;"><i class="fa fa-user"
                                    style="font-size: 15px;margin-left: 2px;margin-right: 5px;"></i>Profil</a>
                            <a href="javascript:void(0)" onclick="daftarFavorit()" style="color: #000;"><i
                                    class="fa fa-heart"></i> Daftar Favorit</a>
                            <a href="javascript:void(0)" onclick="transaksiPembelian()" style="color: #000;"><i
                                    class="fa fa-shopping-bag"></i> Transaksi Pembelian</a>
                            <a href="javascript:void(0)" onclick="logout()" style="color: #000;"><i
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="javascript:void(0)"
                    href="<?= $this->config->item('url_mobile') ?>sampel_desain"><i class="fa fa-home"></i>Beranda</a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="javascript:void(0)" onclick="katalogDesain()"><i
                        class="fa fa-book"></i>Koleksi</a>
            </li>
            <li class="nav-item">
            ...
            <div id="layanan-mobile" style="background: #99b9d5;">
                <div style="margin-left: 10px;color: #004c78;font-weight: normal;font-size: 15px;">Layanan Pengguna
                </div>
...
$(document).ready(function() {
    ...
    if (isMobile() == true) {
        $('.product-grid .image, .product-grid .title, #bottomRight li.share.top').prop('onclick', '').on(
            'click',
            function(e) {
                $(this).trigger('hover');
            });
