...
.single-footer-widget1 {
    display: flex;
    flex-direction: row;
    /* Mengatur elemen-elemen menjadi sejajar horizontal */
    justify-content: flex-end;
    /* Mengatur menu-menu agar berada di ujung kanan */
    float: right;
}
...
#sosmed-dev a i {
    ...
    border-radius: 50%;
    /* Mengatur sudut elemen menjadi lingkaran (untuk ikon bulat) */
    padding: 10px;
    /* Atur padding sesuai dengan kebutuhan */
    position: relative;
    /* Untuk mengatur posisi elemen */


    /* Untuk mengatur lapisan tampilan ikon di atas latar belakang */
}
...
.i-con-footer {
    margin-left: 10px;
    /* Atur jarak antara ikon media sosial jika diperlukan */
}
...
<footer class="footer-area">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="single-footer-widget1" id="layanan-dev"
                style="display: flex; margin-left:20px; margin-top:20px;">

                <div class="menu-footer"><a href=" <?= base_url('kebijakan_privasi') ?>">Tentang Kami</a></div>

                <div class="menu-footer" style="margin-left: -40px;"><a
                        href=" <?= base_url('kebijakan_privasi') ?>">Kebijakan Privasi</a></div>

                <div class="menu-footer" style="white-space: nowrap; margin-left: -20px;"><a
                        href="<?= base_url('syarat_ketentuan') ?>">Syarat dan Ketentuan</a></div>

                <div class="menu-footer" style="margin-left: 15px;"><a href=" <?= base_url('cara_kerja') ?>">Cara
                        Kerja</a></div>

                <div class="menu-footer" style="margin-left: -50px;"><a href=" <?= base_url('faq') ?>">FAQ</a></div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 p0 mo-footer">
                ...
                <div class="single-footer-widget" style="margin-top:50px;">
                    ...
                    <div class="media" style="margin-left:20px;">
                        <img src="<?= base_url('assets/img/logo_RTID.png') ?>" alt="logo"
                            style="width: 80px; height: 50px; margin-right: 10px;">
                        <div class="media-body">

                            <p style="color: #fff; font-size: 15px;">
                                © All rights reserved. Rumah Tinggal 2008 - 2022</br>All images are © each
                                office/photographer mentioned
                            </p>
            ...
            <div class="col-lg-6  col-md-6 col-sm-6 p0 mo-footer mo-footer-color">
                ...
                <div id="sosmed-dev" style="margin-top:-20px;">

                    <a href="https://www.facebook.com/rumahtinggal.id/" target="_blank"><i
                            class="fa fa-facebook i-con-footer" aria-hidden="true"></i></a>

                    <a href="https://www.instagram.com/rumahtinggal.id/" target="_blank"><i
                            class="fa fa-instagram i-con-footer" aria-hidden="true"></i></a>

                    <a href="https://twitter.com/rumahtinggal_id" target="_blank"><i class="fa fa-twitter i-con-footer"
                            aria-hidden="true"></i></a>

                    <a href="https://api.whatsapp.com/send?phone=628112636228&text=Hai%20rumahtinggal.id%2C%20saya%20ingin%20bertanya%20mengenai%20desain%20rumahtinggal.id%20"
                        target="_blank"><i class="fa fa-whatsapp i-con-footer" aria-hidden="true"></i></a>

                    <a href="https://id.pinterest.com/rumahtinggalid" target="_blank"><i
                            class="fa fa-pinterest i-con-footer" aria-hidden="true"></i></a>

                    <a href=" https://mail.google.com/mail/?view=cm&fs=1&to=mail.rumahtinggal@gmail.com&su=Tanya rumahtinggal.id&body=Hai rumahtinggal.id, saya ingin bertanya mengenai desain di rumahtinggal.id"
                        target="_blank"><i class="fa fa-envelope i-con-footer" aria-hidden="true"></i></a>
