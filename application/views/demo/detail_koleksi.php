...
<div class="py-3 d-lg-none">
    <div class="container">
        ...
        <div class="border border-dark rounded-3 card card-body mb-2 mt-3">
            <div class="row align-items-center">
                <div class="col-6">
                    <a href="<?= base_url('paket_pembelian/') . $id_rumah ?>" class="btn btn-success">
                        <i class="fas fa-download me-2"></i> Unduh Gratis
                    </a>
                </div>
                <div class="col-6">
                    <div>Telah didownload <?= $konsep->dilihat ?> kali</div>
                </div>
...
<div>
    <div class="owl-carousel owl-theme owl-carousel-detail d-lg-none mb-0" id="caraouselTesti">
        <div style="background-image: url('<?= base_url('assets/img/konsep/' . $konsep->foto) ?>')" class="card-img-top bg-card-detail ">
            <!-- <div class="position-absolute bottom-0 start-0 bg-light ms-2 rounded-2 p-2 mb-2"> 1/4</div> -->
            <div class="position-absolute top-0 start-0 bg-light ms-2 rounded-2 p-2 mt-2"> Eksterior</div>
        </div>
        <div style="background-image: url('<?= base_url('assets/img/denah/' . $interior->denah) ?> ')" class="card-img-top bg-card-detail">
            <!-- <div class="position-absolute bottom-0 start-0 bg-light ms-2 rounded-2 p-2 mb-2"> 2/4</div> -->
            <div class="position-absolute top-0 start-0 bg-light ms-2 rounded-2 p-2 mt-2"> Denah Lantai 1</div>
        </div>
        <?php if ($interior2 !== null) : ?>
            <div style="background-image: url('<?= base_url('assets/img/denah/') . $interior2->denah ?> ')" class="card-img-top bg-card-detail">
                <!-- <div class="position-absolute bottom-0 start-0 bg-light ms-2 rounded-2 p-2 mb-2"> 2/4</div> -->
                <div class="position-absolute top-0 start-0 bg-light ms-2 rounded-2 p-2 mt-2"> Denah Lantai 2</div>
            </div>
        <?php endif; ?>
        <?php if ($interior3 !== null) : ?>
            <div style="background-image: url('<?= base_url('assets/img/denah/') . $interior3->denah ?> ')" class="card-img-top bg-card-detail">
                <!-- <div class="position-absolute bottom-0 start-0 bg-light ms-2 rounded-2 p-2 mb-2"> 2/4</div> -->
                <div class="position-absolute top-0 start-0 bg-light ms-2 rounded-2 p-2 mt-2"> Denah Lantai 3</div>
            </div>
        <?php endif; ?>

        <div style="background-image: url('<?php echo base_url('assets/demo/img/dismage.png'); ?>')" class="card-img-top bg-card-detail">
            <!-- <div class="position-absolute bottom-0 start-0 bg-light ms-2 rounded-2 p-2 mb-2"> 3/4</div> -->
            <div class="position-absolute top-0 start-0 bg-light ms-2 rounded-2 p-2 mt-2"> Animasi</div>
        </div>
        <div style="background-image: url('<?php echo base_url('assets/demo/img/dismage.png'); ?>')" class="card-img-top bg-card-detail">
            <!-- <div class="position-absolute bottom-0 start-0 bg-light ms-2 rounded-2 p-2 mb-2"> 4/4</div> -->
            ...
            <div class="row">
                <div class="col-lg-7 mb-3 d-none d-lg-block">
                    <div class="position-relative h-100">
                        <div class="slider slider-photos ms-3 h-100">
                            ...
                            <div class="position-absolute bottom-50 translate-middle d-none d-lg-block" style="z-index: 1000; margin-left:460px; ">
                            ...
                            <div class="position-absolute bottom-50 translate-middle d-none d-lg-block" style="z-index: 1000; margin-left:10px;">
                                <button class="btn btn-white border-0 bg-white shadow-sm rounded-circle me-3" id="prevBtnProduk"><i class="fas fa-arrow-left fs-7"></i></button>
                            </div>
                ...
                <div class="col-lg-5 mb-3">
                    <div class="d-none d-lg-block">
                        <h2 id="nama_rumah"><?= $konsep->nama_rumah ?></h2>
                        <h5>Didesain oleh <?= $konsep->nama_arsitek ?></h5>
                    ...
                    <div class="nav nav-pills btn-group border border-primary border-1" id="tab-desain">
                        <button class="nav-link btn btn-outline-primary border border-primary border-1 active" data-id="1" id="konsep" data-bs-toggle="pill" data-bs-target="#pills-konsep" type="button" role="tab" aria-controls="pills-konsep" aria-selected="true">Konsep</button>
                        <button class="nav-link btn btn-outline-primary border border-primary border-1" data-id="2" id="denah" data-bs-toggle="pill" data-bs-target="#pills-denah" type="button" role="tab" aria-controls="pills-denah" aria-selected="true">Denah</button>
                        <button class="nav-link btn btn-outline-primary border border-primary border-1" data-id="3" id="spesifikasi" data-bs-toggle="pill" data-bs-target="#pills-spesifikasi" type="button" role="tab" aria-controls="pills-spesifikasi" aria-selected="true">Spesifikasi</button>
                    </div>
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-konsep" role="tabpanel" aria-labelledby="konsep">
                            <div class="card bg-light mt-3 p-3">
                                <p class="mt-2">Biaya Konstruksi Mulai dari</p>
                                <h3 class="fw-semibold"><?= $konsep->lantai == '1' ? "Rp" . number_format(3500000 * $konsep->luas_bangunan, 0, ",", ".") : ($konsep->lantai == '2' ? "Rp" . number_format(4500000 * $konsep->luas_bangunan, 0, ",", ".") : "Rp" . number_format(5500000 * $konsep->luas_bangunan, 0, ",", ".")); ?></h3>
                                <hr />
                                <div class="row justify-content-between mb-3">
                                    <div class="col-6">
                                        <div class="d-flex align-items-center gap-3 ms-3">
                                            ...
                                            <div>
                                                <small>Ukuran Lahan</small>
                                                <small class="fw-semibold d-block"><?= $konsep->lebar_lahan . ' x ' . $konsep->panjang_lahan . ' m' ?></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                <small>Lantai</small>
                                                <small class="fw-semibold d-block"><?= $konsep->lantai ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-between mb-3">
                                    <div class="col-6">
                                        <div class="d-flex align-items-center gap-3 ms-3">
                                            <div>
                                                <img src="<?php echo base_url('assets/demo/img/llahan.png'); ?>" width="20" height="20">
                                            </div>
                                            <div>
                                                <small>Luas Lahan</small>
                                                <small class="fw-semibold d-block"><?= $konsep->luas_lahan . ' m' ?><sup>2</sup></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <small class="fw-semibold d-block"><?= $konsep->kamar_tidur ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex align-items-center gap-3 ms-3">
                                            ...
                                            <div>
                                                ...
                                                <small class="fw-semibold d-block"><?= $konsep->luas_bangunan . ' m' ?><sup>2</sup></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <small class="fw-semibold d-block"><?= $konsep->toilet ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center gap-3 ms-3">
                                    <div>
                                        <img src="<?php echo base_url('assets/demo/img/gaya_desain.png'); ?>" width="20" height="20">
                                    </div>
                                    <div>
                                        <small>Gaya Desain</small>
                        ...
                        <div class="tab-pane fade" id="pills-denah" role="tabpanel" aria-labelledby="denah">
                            <div class="card bg-light mt-3 p-3" style="max-height: 380px; overflow-y: auto;">
                                <div class="container">
                                    <ul class="nav nav-pills d-flex justify-content-between">
                                        <li class="nav-item w-30 text-center">
                                            <a class="nav-link-denah active rounded-0 bg-light text-dark" id="lantai1-tab" data-bs-toggle="pill" href="#pills-lantai1" role="tab" aria-controls="pills-lantai1" aria-selected="true">Lantai 1</a>
                                        </li>
                                        <li class="nav-item w-30 text-center">
                                            <a class="nav-link-denah rounded-0 bg-light text-dark" id="lantai2-tab" data-bs-toggle="pill" href="#pills-lantai2" role="tab" aria-controls="pills-lantai2" aria-selected="false">Lantai 2</a>
                                        </li>
                                        <li class="nav-item w-30 text-center">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active mt-3" id="pills-lantai1" role="tabpanel" aria-labelledby="lantai1-tab">
                                        <div id="label-lantai1"></div>
                                    </div>
                                    <div class="tab-pane fade mt-3" id="pills-lantai2" role="tabpanel" aria-labelledby="lantai2-tab">
                                        <div id="label-lantai2"></div>
                                    </div>
                                    <div class="tab-pane fade mt-3" id="pills-lantai3" role="tabpanel" aria-labelledby="lantai3-tab">
                                        <div id="label-lantai3"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="pills-spesifikasi" role="tabpanel" aria-labelledby="spesifikasi">
                            <div class="card bg-light mt-3 p-3" style="max-height: 380px; overflow-y: auto;">
                ...
                <div class="col-12">
                    ...
                    <p class="d-none d-lg-block" style="text-align: justify; "><?= $konsep_desain->konsep_desain ?></p>
                    <div class="d-lg-block d-lg-none mx-2" style="text-align: justify; max-height: 160px; overflow-y: auto;">
                        <p><?= $konsep_desain->konsep_desain ?></p>
                    </div>
                </div>
                <div class="col-12 mt-3 px-3">
                    <div class="d-flex justify-content-between align-items-center mt-3 mb-3">
                        <h5 class="fw-semibold">Ulasan</h5>
                        <div class="d-lg-block d-lg-none" style="font-size: 13px;">Lihat Semua</div>
                    </div>
                </div>
                <div class="col-12 d-lg-block d-lg-none px-3">
                    <div class="row">
                        <div class="col-4">
                            <div class="d-flex justify-content-center align-items-center gap-2 mt-5">
                                ...
                                <h1 class="fw-semibold"><?= $rating_desain->rating ?></h1>
                                <h4 class="fw-semibold mt-auto">/5</h4>
                            </div>
                        </div>
                        <div class="col-8">
                ...
                <div class="col-lg-5 mt-3 d-none d-lg-block">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <div class="progress" style="flex-grow: 1; margin-right: 10px;  height: 5px;">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo $rating_empat[0]->rating ?>%; background-color: orange; " aria-valuenow="4" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <i class="fa-solid fa-star text-warning me-2"></i>
                        <span>4</span>
                    </div>
                    <div class="d-flex align-items-center mb-2">
                        <div class="progress" style="flex-grow: 1; margin-right: 10px;  height: 5px;">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo $rating_tiga[0]->rating ?>%; background-color: orange; " aria-valuenow="3" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <i class="fa-solid fa-star text-warning me-2"></i>
                        <span>3</span>
                    </div>
                    <div class="d-flex align-items-center mb-2">
                        <div class="progress" style="flex-grow: 1; margin-right: 10px;  height: 5px;">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo $rating_dua[0]->rating ?>%; background-color: orange; " aria-valuenow="2" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <i class="fa-solid fa-star text-warning me-2"></i>
                        <span>2</span>
                    </div>
                    <div class="d-flex align-items-center mb-2">
                        <div class="progress" style="flex-grow: 1; margin-right: 10px;  height: 5px;">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo $rating_satu[0]->rating ?>%; background-color: orange; " aria-valuenow="1" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <i class="fa-solid fa-star text-warning me-2"></i>
                        <span>1</span>
                    </div>
                ...
                <div class="col-lg-7 px-3">
                    <div id="daftar-ulasan" style="height: 400px; overflow-y: auto;"></div>
                </div>
                <div>
                    <img src="<?php echo base_url('assets/demo/img/banner3.png'); ?>" class="rounded-1 img-fluid d-lg-block d-lg-none">
                </div>
                <div class="border border-dark card card-body mx-4 mt-3 d-lg-block d-lg-none" style="background-color:#056BB7;">
                    <h5 class=" text-center text-white">Konsultasi Gratis </h5>
                    <div class="text-center text-white">Butuh konsultasi dan modifikasi desain hunian Anda</div>
                    <div class="d-flex justify-content-center align-items-center">
                        <button type="button" class="btn btn-light mt-2 w-50 align-items-center" onclick="tanyaDesain()">Hubungi Kami</button>
                    </div>

                </div>
                <div class="col-12 mt-2" id="sectionLine">
                    <hr />
                </div>
            </div>
        </div>
        <div class="col-lg-2 d-none d-lg-block">
            ...
            <div id="scroolFixed">
                <div class="border border-dark rounded-3 card card-body mb-2 my-1">
                    ...
                    <div class="mt-1 text-center">Telah didownload <?= $terjual->terjual ?> kali</div>
                </div>
                <div class="border border-dark bg-primary  card card-body p-3 mb-3">
                    <h5 class="text-white" onclick="tanyaDesain()">Konsultasi Gratis </h5>
                    <div class="text-center text-white">Butuh konsultasi dan modifikasi desain hunian Anda</div>
                    <button type="button" class="btn btn-light w-100 mt-2" onclick="tanyaDesain()">Hubungi Kami</button>
                </div>
                <div>
                    <img src="<?php echo base_url('assets/demo/img/ban_scroll.png'); ?>" style="width: 200px; height: 150px;">
                </div>
            </div>
        </div>
    ...
    <div class="py-2 mt-0">
        <div class="container pb-0">
            ...
            <div class="d-flex justify-content-between flex-column flex-lg-row align-items-center mb-3">
                <h1 class="fw-semibold text-center ms-3 d-none d-lg-block">Rekomendasi Desain</h1>
                <div class="d-none d-lg-block">
                    <a class="btn btn-primary" href="<?= base_url('demo/koleksi') ?>">Lihat Semua<i class="ms-2 fas fa-arrow-right"></i></a>
                </div>
            </div>
                        ...
                        <div class="card border-0 shadow-sm mb-3">
                            ...
                            <div class="card-body">
                                <h5 class="card-title mb-0 fw-semibold" onclick="detailRumah(<?= $item->id_rumah ?>)">
                                    <?= $item->nama_rumah ?></h5>
                                <small class="nama_arsitek mb-0" onclick="detailArsitek(<?= $item->id_rumah ?>)">Design by
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        window.addEventListener("scroll", function() {
            ...
            if (scrollY > centerY && scrollY < stopAt) {
                ...
                scrollFixed.style.top = stopAt + "px";
            } else {
                scrollFixed.style.top = "70px";
            }
                        ...
                        success: function(data) {
                            ...
                            if (data != '') {
                                ...
                                $.each(data, function(i, item) {
                                    ...
                                    $('#label-spesifikasi').append(`<h5 class="fw-semibold mt-3">` + item.bagian_rumah + `</h5>
                                <div>
                                    <div class="row">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data != '') {
                    ...
                    $.each(data, function(i, item) {
                        $('#daftar-ulasan').append(`<div class="position-relative border border-dark rounded-3 px-3 mb-3 mt-3">
                        <div class="d-flex justify-content-between align-items-center my-3">
                                <div class="d-flex justify-content-between gap-2 align-items-center">
                                    <div class="jstars-ulasan" data-value="${item.rating}" data-color="gold" data-size="23px"></div>
                                    <small class="ms-3">${item.tgl_buat}</small>
                            ...
                            <h5 class="fw-semibold">${item.nama_customer}</h5>
                            <p>${item.ulasan}</p>
                        </div>`);
