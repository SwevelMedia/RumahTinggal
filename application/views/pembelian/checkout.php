...
<style>
    ...
    #gSignInMasuk .abcRioButton.abcRioButtonBlue {
        margin: 0 auto;
    }
    ...
    .hover .text-bulan span,
    .card:hover .text-bulan span {
    ...
    .cart .basket .card:hover .price-durasi,
    .cart .basket .card:hover .main-description,

    .cart .basket .card:hover .text-bulan,
    .cart .basket .card:hover .strike {
        color: #fff;
    }
    ...
    .modal-subscribe .modal-dialog .modal-content .modal-body .form-control::placeholder {
        font-size: 14.5px;
    }
    ...
    .modal-subscribe .modal-dialog .modal-content .modal-body .subscribe i {
        padding-right: 5px;
    }
    ...
    #ModalSubscribe .modal-dialog .modal-content .modal-body .title {
        font-size: 32px;
    }
    ...
    #ModalSubscribe .modal-dialog .modal-content .modal-body .subscribe {
        width: 120px;
    }
                    ...
                    <div class="col-md-4 pr-0 m-0" style="max-width: 45%;flex: 0 0 45%;vertical-align: middle;">
                        ...
                        <div style="vertical-align: middle;display: inline;padding: 1px;">
                            ...
                            <div class="card-group">
                                ...
                                <div class="sec-spec">: 11.00 m x 9.00 m</div>
...
<script>
    var id_pengguna, paket, info_bonus, info_bonus_terpilih, pros_diskon = 0,
        diskon_promo = 0;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.Success == true) {
                        ...
                        var kategori = Cookies.get('kategori', {
                            domain: 'estimator.id'
                        });
    ...
    $('#corp-twenty-four-month').click(function() {
        ...
        if (jumlah_akun != 3) $('.bonus-training').show();
        else $('.bonus-training').hide();
