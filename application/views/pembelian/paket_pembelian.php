    ...
    <div class="col-md-2 col-sm-6" style="padding: 0;">
      ...
      <div class="pricingTable free">
        ...
        <div class="pricingTable-header">
          ...
          <div class="text-center"><img src="<?= base_url('assets/img/paper-plane.png') ?>" style="width:50px;" /></div>
  ...
  function simpanAlamatBaru() {
    ...
    if ($("#ubah_alamat_utama").is(':checked')) {
      ...
      $.ajax({
        ...
        url: "<?php echo base_url() ?>api/ubahAlamatCustomer",
  ...
  $(document).ready(function() {
    ...
    $('.select2-provinsi').select2({
      ...
      ajax: {
        ...
        url: "<?php echo base_url('api/getListWilayahProvinsi') ?>",
        dataType: 'json',
    ...
    $('.select2-kabupaten').select2({
      ...
      ajax: {
        ...
        url: "<?php echo base_url('api/getListWilayahKabupaten') ?>",
    ...
    $('.select2-kecamatan').select2({
      ...
      ajax: {
        ...
        url: "<?php echo base_url('api/getListWilayahKecamatan') ?>",
    ...
    $('.select2-kelurahan').select2({
      ...
      ajax: {
        ...
        url: "<?php echo base_url('api/getListWilayahKelurahan') ?>",
