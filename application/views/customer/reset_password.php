...
<div id="box">
  ...
  <form id="myform-search" method="post" autocomplete="off" onsubmit="event.preventDefault();return resetPasword()">
    <h1>Reset Kata Sandi <span>Atur ulang kata sandi Anda</span></h1>
    <form>
      <p>
        <input type="password" class="password" id="password_baru" name="password" placeholder="Kata sandi baru" required />
        <button class="unmask" type="button"></button>
      </p>
      <p>
        <input type="password" class="password" id="ulang_password_baru" name="password" placeholder="Ulang kata sandi baru" required />
        <button class="unmask" type="button"></button>
