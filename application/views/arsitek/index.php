...
<style type="text/css">
  ...
  background-image: linear-gradient(to bottom, transparent 0%, #026CB6 100%);*/
    ...
    .product-grid .product-statistic {
    ...
    .product-grid .product-feature .feature {
        text-align: center;
    }
    ...
    .product-grid .product-feature .feature sup {
        color: #000;
    }



    .product-grid [data-tootik]::before {
...
<div class="mt-5" style="background: #026CB6; line-height: 50px;">
    <h2 style="color: #fff;line-height: 50px !important" class="text-center">PORTOFOLIO</h2>
</div>
                ...
                <div class="col-md-2 col-sm-6 p0 grid" style="float: left;">
                    ...
                    <figure class="snip1361 white">
                        ...
                        <figcaption>
                            ...
                            <p><?= $item->kategori ?></p>
                            <hr style="margin: 0 !important;background:#fff;">
                            <p>
