      ...
      <form id="msform"> 
        ...
        <fieldset>
          ...
          <div class="col-md-12 mb-5">
            ...
            <div class="row">
              ...
              <div class="col-md-5">
                  <div> 
                    <div style="font-size: 15px;text-align: left;font-weight: 600;">Jumlah Kamar Tidur</div>
                    <div class=' p-none'>
                       <div class='mt-1'>
        ...
        <fieldset>
          ...
          <div class="col-md-12 mb-5">
              <div class="text-center">
                 <h4> TOILET</h4>
                  <p style="font-size: 15px;">Toilet juga merupakan kebutuhan utama di dalam rumah tinggal.<br> Tentukan jumlah toilet yang Anda butuhkan di dalam rumah tinggal Anda</p>
              </div>
              <div class="row">
        ...
        <fieldset style="position:relative !important;">
          ...
          <button type="button" class="top-next next action-button gaya-desain-button">Selanjutnya</button>  
           <div class="col-md-12">
                <div class=" text-center">
                <h4>GAYA DESAIN</h4>
                <p style="font-size: 15px;">Terdapat berbagai jenis gaya desain. Pilihlah gaya desain yang Anda senangi. (Dapat memilih lebih dari satu)</p>
                </div>
                    ...
                    <div class="col-md-4" style="margin-left: 0px;"> 
                        ...
                        <div class="custom-control custom-checkbox image-checkbox mt-4 gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd1">
                                <img src="assets/img/assessment/gaya_desain/modernRumah.jpg" alt="#" class="img-fluid" style="width: 220px;height: 165px;">
                        ...
                        <div class="custom-control custom-checkbox image-checkbox gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd4">
                                <img src="assets/img/assessment/gaya_desain/kontemporerRumah.jpg" alt="#" class="img-fluid" style="width: 220px;height: 165px;">
                        ...
                        <div class="custom-control custom-checkbox image-checkbox gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd7">
                                <img src="assets/img/assessment/gaya_desain/klasikRumah.jpg" alt="#" class="img-fluid" style="width: 220px;height: 165px;">
                    ...
                    <div class="col-md-4"> 
                        <div class="custom-control custom-checkbox image-checkbox mt-4 gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd2">
                                <img src="assets/img/assessment/gaya_desain/minimalisRumah.png" alt="#" class="img-fluid" style="width: 220px;height: 165px;">
                        ...
                        <div class="custom-control custom-checkbox image-checkbox gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd8">
                                <img src="assets/img/assessment/gaya_desain/skandinavianRumah.jpg" alt="#" class="img-fluid" style="width: 220px;height: 165px;">
...
{
   window.open("https://rumahtinggal.id/mobile/assessment");
}
else
{
