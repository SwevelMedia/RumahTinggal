    ...
    <div class="container">
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-12 mt-100 p0 center">
                ...
                <button class="btn btn-banner danger" onclick="konsultasiDesain()" style="position: relative;left: 0;bottom: 3%;font-size: 16px;padding: 6px 12px;">KONSULTASI
                    DESAIN</button>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 bg-side">
                ...
                <div style="box-shadow: 0px 2px 3px 2px #d7d7d7;padding: 16px 6px;border-radius: 14px;background: #026CB61C;margin-top: 17px;">

                    <h4 class="my-2 center">Tampilkan Desain</h4>

                    <p class="center" style="color: #000;margin-bottom: 10px;font-size:13px;">Temukan desain rumah
                        tinggal yang tepat<br>melalui fitur asesmen</p>

                    <center><button style="padding: 5px 28px;color: #fff;font-size: 15px;border-radius: 20px;" class="btn btn-danger" onclick="temukanDesain()">Mulai</button></center>
            ...
            <div class="col-md-9" style="padding-right: 0;padding-left: 10px;">
                ...
                <div class="spinner">
                    ...
                    <center><img src="<?= base_url('assets/gif/rt-loader.gif') ?>" style="padding: 2px;" width="35px" />
                    </center>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#lebar_lahan,#panjang_lahan,#harga_konstruksi,#lantai,#jum_kamar_tidur,.ruang_lain,.gaya_desain,#inputGroupSelect02,#order,#cari_rumah')
            .on('change', function() {
    ...
    function getDesainItem(page, data) {
        ...
        let biaya = data.lantai == '1' ? 3500000 * data.luas_bangunan : (data.lantai == '2' ? 4500000 * data.luas_bangunan :
            5500000 * data.luas_bangunan);

        let promo = data.promo != '0' ? '<div class="ribbon"><span class="ribbon-promo">Cut-Off ' + data.promo +
            '%</span></div>' : '';
            ...
            `
                ...
                <div class="product-content">
                    ...
                    <div class="product-detail">
                        ...
                        <p>Biaya konstruksi <span style="font-weight: 400;" data-tootik="Estimasi awal" data-tootik-conf="square">` +
            number_format(biaya, 0, ',', '.') + `</span></p>
                ...
                success: function(data) {
                    ...
                    if (data != '') {
                        ...
                        $.each(data, function(i, item) {
                            ...
                            $('.like[data-id="' + id_rumah + '"] .fa').removeClass('fa-heart-o')
