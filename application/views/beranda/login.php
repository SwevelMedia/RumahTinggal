<style>
    ...
    #box-login.right-panel-active .sign-in-container {
    ...
    #box-login.right-panel-active .overlay-container {
        transform: translateX(-100%);
    }
    ...
    #box-login.right-panel-active .overlay {
    ...
    #box-login.right-panel-active .overlay-left {
        transform: translateX(0);
    }
    ...
    #box-login.right-panel-active .overlay-right {
        transform: translateX(20%);
    }
    ...
    #ModalLogin button:active {
        transform: scale(0.95);
    }



    #ModalLogin button:focus {
        outline: none;
    }
            ...
            <div id="box-login">
                ...
                <div class="form-container sign-up-container">
                    ...
                    <form id="frm-daftar" name="frm-daftar">
                        ...
                        <div id="panel-daftar">
                            <!-- style="transform: scale(0.8,0.6) !important;width: 155px;" -->
                ...
                <div class="form-container sign-in-container">
                    ...
                    <form id="frm-login" class="frm-login-mo">
                        ...
                        <div id="panel-login-akun">
                            ...
                            <button type="button" onclick="loginAkun($('#email_login').val(),$('#password_login').val())">Masuk</button>
                            <br>
                    ...
                    <input type="password" id="ulang_password_baru" name="password" placeholder="Ulang password baru" /> -->
                            ...
                            <button type="button" onclick="sendMail($('#email_lupa_password').val())">Kirim link
                                reset</button>
...
<script>
    ...
    $('#btn-daftar').click(function() {
        ...
        if (document.forms['frm-daftar'].email.value === "" || document.forms['frm-daftar'].nama_lengkap.value ===
            "" || document.forms['frm-daftar'].password.value === "" || document.forms['frm-daftar'].password_ulang
            .value === "") {
            ...
            if (password == password_ulang) {
                ...
                toastr.info('Password yang anda masukkan tidak sama', 'Informasi', opsi_toastr);
            }
                    ...
                    if (response != null) {
                        ...
                        $.ajax({
                            ...
                            success: function(response_otp) {
                                ...
                                no_wa = response_otp.no_wa.replace(
                                    /(\d{4})(\d{3})(\d{3})(\d{3})/, "$1-***-***-$4");

                                if (response_otp.status == '1') {

                                    $('#info_verifikasi').html(
                                        'Kode verifikasi telah dikirimkan ke nomor WhatsApp <strong>' +
                                        no_wa + '</strong>.<br>Belum mendapatkan kode?');
                                    ...
                                    $('#info_verifikasi').html(
                                        'Gagal mengirimkan kode verifikasi ke nomor WhatsApp <strong>' +
                                        no_wa + '</strong>');
                        ...
                        alert(
                            'Nomor WhatsApp Anda belum terdaftar. Silakan lakukan pendaftaran akun baru terlebih dulu.'
                        );
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status == 1) {
                    ...
                    $('#kirim-ulang-otp').attr('disabled', true).html(
                        'Kirim ulang kode (<span class="otp-timer" data-rooster-seconds=60 data-rooster-onComplete="$(this).hide()"></span>)'
                    );
                    ...
                    $('.otp-timer').rooster(
...

                        {
                            ...
                            oncomplete: function() {
                                ...
                                $('#kirim-ulang-otp').attr('disabled', false).html(
                                    'Kirim ulang kode');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 0) {
                        ...
                        toastr.success(response.info, 'Berhasil', opsi_toastr);
                    }
