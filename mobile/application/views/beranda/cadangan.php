 ...
 <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://s3.envato.com/files/264985456/720x300_pop-under.jpg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="https://www.vivahouz.com/image/cache/catalog/slideshow/vivahouz_web_banner_7-1170x500.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
...
<!-- <div class="line-batas mt-4"> </div> -->
<!-- <section class="offered-area section-gap" id="offered">
   <center> <h3><strong> Desain Rumah Popular</strong></h3> <p>Temukan ratusan desain rumah eksklusif sesuai keinginan Anda</p></center>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="card h-100">
                            <a href="#">
                                <img class="card-img-top" src="https://i.pinimg.com/originals/3e/8d/0a/3e8d0a2b826cddce9878185152355c45.jpg" alt="">
                            </a>
                            <div class="card-body">
                                <h4 class="card-title title-weight">
                                  <a href="#" class="black">RUMAH MINIMALIS RAMAH LINGKUNGAN</a>
                                </h4>
                                <p class="card-text">Design By <span style="color: #00ced1;">TR Studio</span></p>
                                <div>
                                <div class="card-group">
                                  <div style="margin :8px 24px 8px 0px;">
                                      <img src="assets/img/icon/Icon Luas Lahan.png" class="card-img-top icon-sub" alt="..." >
                                      <p class="card-title" style="font-size: 9px;">70 m<sup>2</sup></p>
                                  </div>
                            <div style="margin :8px 24px 8px 0px;">
                        ...
                        <p class="card-text center">Dimensi Lahan Minimal <br>
                          <span><strong>(6m x 12m)</strong></span>
                        </p>
                            </div>
                            <div>
                                <div class="card-group">
                                    <div style="margin: 0px 13px 20px;">
                                        <a href="#" class="genric-btn genric-btn-portant success circle button-detail" style="margin-top: 2px;">Detail</a>
                                    </div>
                                    <div class="icon-medd">
    ...
    <center><a href="#" class="genric-btn danger radius" style="padding: 0 17px;"><strong>LIHAT SEMUA</strong></a></center>
</section> -->

<!-- <section class="offered-area mt-5" id="">
<center> <h3><strong> Desain Rumah Popular</strong></h3> <p style="font-size: 15px;">Temukan ratusan desain rumah eksklusif sesuai keinginan Anda</p></center>
</section> -->
<section class="pb-4">
  <div class="container">
    <div class="row">
...
<!-- 
                    ...
                    <div class="carousel-item">
                        <div class="row" id="rumah-popular3"> -->
                            <!-- <div class="col-md-3 mb-3">
                                <div class="card h-100">
                            <a href="#">
                                <img class="card-img-top" src="https://i.pinimg.com/originals/3e/8d/0a/3e8d0a2b826cddce9878185152355c45.jpg" alt="">
...
<!-- <section class="offered-area section-gap" id="offered">
<div class="container">
  <center> <h3><strong> Artikel Terbaru </strong></h3> <p>Dapatkan ratusan artikel menarik tentang rumah Anda</p></center>
    <div class="row">
        <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-3">
...
<center><a href="#" class="genric-btn danger radius mt-5 mb-5" style="padding: 0 17px;"><strong>LIHAT SEMUA</strong></a></center>
</section> -->
<!-- start footer Area -->    
    ...
    <div class="row">
      <div class="col-lg-3  col-md-6 col-sm-6">
        <div class="single-footer-widget">
          <h4 class="text-white">Rumah Tangga</h4>
          <div class="line"></div>
          <p style="width: 16em;color: #a29797;">
            Website Rumah Tinggal ini dibangun untuk Anda dalam mewujudkan perencanaan pembuatan rumah tinggal dengan desain yang beragam.
          </p>
        </div>
      </div>
      <div class="col-lg-3  col-md-6 col-sm-6">
        <div class="single-footer-widget">
          ...
          <div class="line"></div>
          <p style="width: 16em;color: #a29797;">
            Untuk Anda dalam mewujudkan perencanaan pembuatan rumah tinggal dengan desain yang beragam.
          </p>
        </div>
      </div>  
      <div class="col-lg-3  col-md-6 col-sm-6">
        <div class="single-footer-widget">
          <h4 class="text-white">Tags Widget</h4>
          <div class="line"></div>
          <a href="#" class="genric-btn success-border circle tag" style="margin:2px;">Rumah Tinggal</a>
          <a href="#" class="genric-btn success-border circle tag">1 Lantai</a>
          <a href="#" class="genric-btn success-border circle tag">2 Lantai</a>
          <a href="#" class="genric-btn success-border circle tag">Fasilitas</a>
        </div>
      </div>            
      <div class="col-lg-3  col-md-6 col-sm-6">
        <div class="single-footer-widget">
          ...
          <div class="line"></div>
          <p> <i class="fa fa-facebook i-con" aria-hidden="true"></i>
            <i class="fa fa-instagram i-con" aria-hidden="true"></i>
              <i class="fa fa-whatsapp i-con" aria-hidden="true"></i>
          </p>
        </div>
      </div>  
    </div>
...
<!--  <p class="footer-text m-0">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a></p>
Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0.
