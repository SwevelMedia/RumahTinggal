...
#spesifikasi .product-grid .product-statistic .view, .product-grid .product-statistic .like {
    color: #000;
    padding-left: 0px;
}
...
.product-grid .product-statistic .share .fa {
   ...
   #katalog-produk-filter .product-grid .product-statistic .view .fa {
        font-size: 15px !important;
        padding-right: 2px;
        margin-top: 2px;
    }
   #katalog-produk-filter .product-grid .product-statistic .like .fa {
        font-size: 13px !important;
        padding-right: 2px;
        margin-top: 2px;
    }
   #katalog-produk-filter .product-grid .product-statistic .share .fa {
        font-size: 14px !important;
        padding-right: 2px;
        margin-top: 2px;
    }
   #katalog-produk-filter .product-grid .product-statistic .view {
        font-size: 9px !important;
       
    }
   #katalog-produk-filter .product-grid .product-statistic .like span.value {
        font-size: 9px !important;
   ...
   #katalog-produk-filter .product-grid .product-statistic .view, #katalog-produk-filter  .product-grid .product-statistic .like {
        color: #000;
        padding-left: 0px;
    }

    #katalog-produk-filter .slick-track .grid .product-grid .product-content .product-detail .product-statistic .statistic .btn-detail{
        padding: 1px 5px !important;
        font-size: 12px !important;
    }
    #katalog-produk-filter .product-grid .product-image{
        height: 133px !important;
    }
    #katalog-produk-filter .product-grid .title {
        font-size: 11px !important;
    }
    #katalog-produk-filter .product-grid .arsitek{
        font-size: 10px !important;
        width: 53% !important;
    }
    #katalog-produk-filter .product-grid .jstars::after{
        font-size: 9px !important;
    }
    #katalog-produk-filter .product-grid .product-detail p{
        font-size: 9px !important;
    }
    #katalog-produk-filter .btn-detail.favorit {
    ...
    /*#katalog-produk-filter .jstars .jstars-empty{
        font-size: 10px !important;
    }*/
    #katalog-produk-filter .jstars{
        margin-top: -6px !important;
    }
    /*#katalog-produk-filter .product-grid .product-feature .feature span {
        font-size: 10px !important;
    }*/
     #katalog-produk-filter .product-grid .product-feature .feature img {
        width: 20px !important;
        height: 20px !important;
    }
    #katalog-produk-filter .product-grid .product-rating{
        /*display: initial;*/
    }
    #katalog-produk-filter .jstars .jstars-empty {
        font-size: 12px !important;
    }
    #katalog-produk-filter .jstars .jstars-empty .jstars-filled {
        font-size: 12px !important;
    }
    ...
    #katalog-produk-filter .product-grid {
        margin: 0 5px !important;
        width: 170px;
    }
    #katalog-produk-filter .product-grid .product-feature {
...
.custom-control-input:checked ~ .custom-control-label-x::before {
  ...
  #frm-assessment.multi_step_form #msform #progressbar li:before {
     content: "1";
  font-size: 10px;
  width: 20px;
  height: 20px;
  ...
  #frm-assessment.multi_step_form #msform #progressbar li:not(:first-child):after {
  content: '';
  width: 100%;
  height: 4px;
  background: #eaf0f4;
      ...
      <form id="msform" class="mt-4"> 
        ...
        <fieldset>
          ...
          <div class="row">
                ...
                <div class="col-md-5">
                    <div>
                       <h5>UKURAN LAHAN </h5>
                       <p style="font-size: 13px;">Luas lahan ditentukan berdasarkan Lebar Lahan (L) dan Panjang Lahan (P) maksimal yang dapat dibangun untuk rumah tinggal Anda</p>
                    </div>
                    <img src="<?= base_url('assets/img/assessment/assessment-denah.png') ?>" style="height: 300px; margin-left: 0rem;width: 227px;"> 
                </div>
                <div class="col-md-7">
                    <div class="text-left mt-5">
                        
                        <div> 
                            <p style="font-size: 16px; margin-bottom: 0;">Lebar Lahan (L)</p>
                            <p style="font-size: 13px;">Lebar lahan adalah sisi pintu masuk utama masuk rumah tinggal Anda <br> Tentukan lebar lahan maksimal yang dapat dibangun.</p>
                            <strong style="font-size: 15px;">Lebar Lahan (m)</strong>
                            <div class='p-none' style="width: 90%;">
                                <input type="text" class="js-range-slider-lebar" name="lebar_lahan" value=""/> 
                            </div>
                        </div>
                        <div> 
                           <p style="font-size: 16px; margin-bottom: 0;margin-top: 2rem;">Panjang Lahan (P)</p>
                           <p style="font-size: 13px;">Panjang lahan adalah sisi samping rumah tinggal Anda. <br> Tentukan panjang lahan maksimal yang dapat dibangun.</p>
        ...
        <fieldset>
         ...
         <div class="col-md-12 mt-4">
            ...
            <div class="text-center">
              <h5>JUMLAH LANTAI </h5>
              <p style="font-size: 13px;">Tentukan jumlah lantai rumah tinggal yang Anda inginkan. <br>Tersedia pilihan rumah tinggal 1 lantai atau 2 lantai.</p>
            </div>
            <div class="row">
            <div class="grid-wrapper" style="margin:0 auto; width: auto;">  
              <div class="card-wrapper" style="width: 130px !important;float: left;">  <input type="checkbox" class="custom-control-input" name="lantai[]" value="0" id="" hidden checked>
                  <div class="card-content custom-control custom-checkbox image-checkbox">
                    ...
                    <label class="custom-control-label-d" for="check-1lt">
                        ...
                        <label for="check-1lt">
                        <div class="image mb-3"><img class="image" src="<?= base_url('assets/img/assessment/muka_lantai/1_lantai.jpg') ?>"></div>
                        <h5 style="font-size: 16px !important;"><strong>1 Lantai</strong></h5>
                        <p class="small-meta" style="font-size: 13px;">Rumah 1 lantai cocok untuk Anda yang menginginkan rumah tinggal yang sederhana dan hemat biaya.</p>
                       </label>
                    </label>
                  </div>
              </div>

              <div class="card-wrapper" style="width: 130px !important;float: left;">
                <div class="card-content custom-control custom-checkbox image-checkbox">
                  ...
                  <label class="custom-control-label-d" for="check-2lt">
                      <div class="card-state-icon"></div>
                      <label for="check-2lt">
                        <div class="image mb-3"><img class="image" src="<?= base_url('assets/img/assessment/muka_lantai/2_lantai.jpg') ?>"></div>
                        <h5 style="font-size: 16px !important;"><strong>2 Lantai</strong></h5>
                        <p class="small-meta" style="font-size: 13px;">Rumah 2 lantai cocok untuk Anda yang menginginkan rumah tinggal yang memiliki banyak ruang di lahan terbatas.</p>
                      </label>
                  </label>
                 </div>
              </div>
        ...
        <fieldset>
          ...
          <div class="col-md-12 mt-4">
             ...
             <div class=" text-center">
                <h5>MUKA BANGUNAN</h5>
                <p style="font-size: 13px;">Tentukan jumlah muka bangunan rumah tinggal Anda yang terlihat dari jalan</p>
             </div>
             <div class="row">
             <div class="grid-wrapper" style="margin:0 auto;width: auto;">  
                <div class="card-wrapper" style="width: 130px !important;float: left;"> <input type="checkbox" class="custom-control-input" name="muka[]" value="0" id="" hidden checked>
                   <div class="card-content custom-control custom-checkbox image-checkbox">
                       <input type="checkbox" class="custom-control-input" name="muka[]" value="1" id="check-1mk" checked>
                        <label class="custom-control-label-d" for="check-1mk">
                          <div class="card-state-icon"></div>
                          <label for="check-1mk">
                            <div class="image mb-3"><img class="image" src="<?= base_url('assets/img/assessment/muka_lantai/1_muka.jpg') ?>"></div>
                            <h5 style="font-size: 16px !important;"><strong>1 Muka</strong></h5>
                            <p class="small-meta" style="font-size: 13px;">Rumah tinggal 1 muka biasanya diperuntuk kan apabila di sisi samping lahan Anda sudah terdapat bangunan lain</p>
                          </label>
                        </label>
                    </div>
                 </div>
                 <div class="card-wrapper" style="width: 130px !important;float: left;">
                   <div class="card-content custom-control custom-checkbox image-checkbox">
                       ...
                       <label class="custom-control-label-d" for="check-2mk">
                         <div class="card-state-icon"></div>
                         <label for="check-2mk">
                           <div class="image mb-3"><img class="image" src="<?= base_url('assets/img/assessment/muka_lantai/2_muka.jpg') ?>"></div>
                           <h5 style="font-size: 16px !important;"><strong>2 Muka</strong></h5>
                           <p class="small-meta" style="font-size: 13px;">Rumah tinggal 2 muka diperuntuk kan apabila minimal terdapat 2 sisi samping rumah Anda yang berbatasan dengan jalan</p>
                         </label>
                       </label>
                    </div>
                  </div>
        ...
        <fieldset>
          ...
          <div class="col-md-12 mt-4">
             <div class="text-center mb-2">
                <h5>KAMAR TIDUR</h5>
                <p style="font-size: 13px;">Tentukan jumlah kamar tidur yang anda butuhkan dengan pertimbangan jumlah anggota keluarga anda. <br> Anda juga dapat memperhitungkan kamar tidur untuk tamu atau ART (Asisten Rumah Tangga).</p>
            </div>
            
            <div class="row">
              <div class="col-md-6">
                <div>
                  <img src="<?= base_url('assets/img/assessment/kamarTidur1.jpg') ?>" class="rounded mb-3" alt="..." style="width:295px;height: 210px;">
                </div>
              </div>
              <div class="col-md-5">
                  <div> 
                    <div style="font-size: 15px;font-weight: 600;">Jumlah Kamar Tidur</div>
                    <div class=' p-none'>
                       <div class='mt-1'>
        ...
        <fieldset>
          ...
          <div class="col-md-12 mb-4 mt-4">
              <div class="text-center">
                 <h5> TOILET</h5>
                  <p style="font-size: 13px;">Tentukan jumlah toilet yang Anda butuhkan di dalam rumah tinggal Anda</p>
              </div>
              <div class="row">
                <div class="col-md-7">
                    <img src="https://d3p0bla3numw14.cloudfront.net/news-content/img/2019/04/14090018/GettyImages-881475252-2.jpg" class="rounded mb-3" alt="..." style="width:295px;height: 210px;">
                </div>
                <div class="col-md-4"> 
                    <div class='p-none'>
                        <h5> Jumlah Toilet</h5>
                     ...
                     <div class="mt-1"> 
                         <h5>Toilet Dalam</h5>
                         <p class="" style="font-size: 13px; margin-bottom: 0px">Apakah Anda membutuhkan toilet yang dapat diakses dari dalam kamar tidur ?</p>
                         <div class='p-none'>
                             <div class="card-group">
                                <div class="card-group" style="margin: 0 auto;">
                                    ...
                                    <div class="">
                                        <label>
                                            <input type="checkbox" name="kamar_mandi_dalam" class="checkbox-km-dalam" value="1"> <span class="label-text" style="font-size: 13px; font-weight: 500;color: #4e4e4e;">Ya</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label>
                                            <input type="checkbox" name="kamar_mandi_dalam" class="checkbox-km-dalam" value="2" checked> <span class="label-text" style="font-size: 13px; font-weight: 500;color: #4e4e4e;">Tidak</span>
                                        </label>
                                    </div>
                                </div>
                             </div>
                     ...
                     <div class="mt-3"> 
                         <h5>Wastafel</h5>
                         <p class="" style="font-size: 13px; margin-bottom: 0px">Apakah Anda membutuhkan wastafel didalam toilet ?</p>
                         <div class='p-none'>
                              <div class="card-group">
                                 <div class="card-group" style="margin: 0 auto;">
                                  ...
                                  <div class="">
                                      <label>
                                          <input type="checkbox" name="wastafel" class="checkbox-wastafel" value="1"> <span class="label-text" style="font-size: 13px; font-weight: 500;color: #4e4e4e;">Ya</span>
                                      </label>
                                  </div>
                                  <div class="form-check">
                                      <label>
                                          <input type="checkbox" name="wastafel" class="checkbox-wastafel" value="2" checked> <span class="label-text" style="font-size: 13px; font-weight: 500;color: #4e4e4e;">Tidak</span>
                                      </label>
                                  </div>
                              </div>
                          </div>
                    ...
                    <div class="mt-3"> 
                      <h5>  Kloset</h5>
                          <p class="" style="font-size: 13px; margin-bottom: 0px">Jenis kloset apa yang Anda inginkan ?</p>
                          <div class='p-none'>
                                 ...
                                 <div class="card-group" style="margin: 0 auto;">
                                      <div class=""><input type="checkbox" name="kloset_duduk" class="checkbox-kloset" value="0" checked hidden> 
                                          <label class="kloset_duduk_cek">
                                              <input type="checkbox" name="kloset_duduk" class="checkbox-kloset" value="1" required="required" checked> <span class="label-text" style="font-size: 13px; font-weight: 500;color: #4e4e4e;">Duduk</span>
                                          </label>
                                      </div>
                                      <div class="form-check"> <input type="checkbox" name="kloset_jongkok" value="0" class="checkbox-kloset" checked hidden>
                                          <label class="kloset_duduk_cek"> 
                                              <input type="checkbox" name="kloset_jongkok" value="1" class="checkbox-kloset"  class="required" checked> <span class="label-text" style="font-size: 13px; font-weight: 500;color: #4e4e4e;">Jongkok</span>
                                          </label>
                                      </div>
                                 </div>
                              </div>
        ...
        <fieldset>
          ...
          <button type="button" class="top-next next action-button">Selanjutnya</button>  
           <div class="col-md-12 mt-2">
              <div class=" text-center">
                  <h5>RUANG LAINNYA</h5>
                  <p style="font-size: 13px;">Pilihlah ruang-ruang lain yang Anda butuhkan. (Dapat memilih lebih dari satu)</p>
              </div>
              <div class="row">  
                      ...
                      <div class="row">
                          <div class="col-12">
                              <div class="row" id="rumah-terbaru1"> -->
                                  <div class="col-md-4" style="margin-left: 0px;flex: 0 0 33%;max-width: 33%;"> 
                                      <input type="checkbox" class="custom-control-input" name="ruang_lain[]" value="0" id="" hidden checked>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2 p-0">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl1">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/carport.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Carport</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl5">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/ruangTamu.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Ruang Tamu</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl7">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/kamarTidur.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Kamar tidur</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl12">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/gudang.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Gudang</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl4">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/taman.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Taman</label> </center>
                                          </label>
                                      </div>
                                  </div>
                                  <div class="col-md-3" style="flex: 0 0 33%;max-width: 33%;"> 
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl2">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/garasi.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Garasi</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl6">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/ruangKeluarga.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Ruang Keluarga</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl16">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/toilet.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Toilet</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl10">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/ruangCuci.png') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;"> Ruang Cuci</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl8">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/dapur.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Dapur</label> </center>
                                          </label>
                                      </div>
                                  </div>
                                  <div class="col-md-3" style="flex: 0 0 33%;max-width: 33%;"> 
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl3">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/teras.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Teras</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl11">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/ruangMakan.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Ruang Makan</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl15">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/kamarMandiToilet.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Toilet Dalam</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl9">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/ruangJemur.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Ruang Jemur</label> </center>
                                          </label>
                                      </div>
                                      <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl13">
                                              <img src="<?= base_url('assets/img/assessment/mushola.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Mushola</label> </center>
                                          </label>
                                      </div>
                                  </div>
                                  <div class="col-md-4" style="flex: 0 0 33%;max-width: 33%;"> 
                                      <!-- <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          <input type="checkbox" class="custom-control-input" name="ruang_lain[]" value="4" id="check-rl4">
                                          <label class="custom-control-label-b" for="check-rl4">
                                              <img src="<?= base_url('assets/img/assessment/ruang_lain/taman.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                      ...
                                      <!-- <div class="custom-control custom-checkbox image-checkbox mt-2">
                                          ...
                                          <label class="custom-control-label-b" for="check-rl17">
                                              <img src="<?= base_url('assets/img/assessment/kolamRenang.jpg') ?>" alt="#" class="img-fluid" style="width: 84px;height: 84px;">
                                              <center> <label style="font-size: 13px;">Kolam Renang</label> </center>
                                          </label>
                                      </div> -->
                                  </div>
                             <!-- </div>
        ...
        <fieldset style="position:relative !important;">
          ...
          <button type="button" class="top-next next action-button gaya-desain-button">Selanjutnya</button>  
           <div class="col-md-12 mt-4">
                <div class=" text-center">
                <h5>GAYA DESAIN</h5>
                <p style="font-size: 13px;">Terdapat berbagai jenis gaya desain. Pilihlah gaya desain yang Anda senangi. (Dapat memilih lebih dari satu)</p>
                </div>
            <!-- <input type="checkbox" id="checkall" >Check/Uncheck All -->
             <div class="custom-control custom-checkbox">
                ...
                <div class="row" id="cekgayadesain">  
                    ...
                    <div class="col-md-4" style="margin-left: 0px; max-width: 33%;"> 
                        ...
                        <div class="custom-control custom-checkbox image-checkbox mt-4 gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd1">
                                <img src="<?= base_url('assets/img/assessment/gaya_desain/modernRumah.jpg') ?>" alt="#" class="img-fluid" style="width: 220px;height: 85px;">
                        ...
                        <div class="custom-control custom-checkbox image-checkbox gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd4">
                                <img src="<?= base_url('assets/img/assessment/gaya_desain/kontemporerRumah.jpg') ?>" alt="#" class="img-fluid" style="width: 220px;height: 85px;">
                        ...
                        <div class="custom-control custom-checkbox image-checkbox gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd7">
                                <img src="<?= base_url('assets/img/assessment/gaya_desain/klasikRumah.jpg') ?>" alt="#" class="img-fluid" style="width: 220px;height: 85px;">
                    ...
                    <div class="col-md-4" style="max-width: 33%;"> 
                        <div class="custom-control custom-checkbox image-checkbox mt-4 gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd2">
                                <img src="<?= base_url('assets/img/assessment/gaya_desain/minimalisRumah.png') ?>" alt="#" class="img-fluid" style="width: 220px;height: 85px;">
                        ...
                        <div class="custom-control custom-checkbox image-checkbox gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd5">
                                <img src="<?= base_url('assets/img/assessment/gaya_desain/rumahTropis.jpg') ?>" alt="#" class="img-fluid" style="width: 220px;height: 85px;">
                        ...
                        <div class="custom-control custom-checkbox image-checkbox gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd8">
                                <img src="<?= base_url('assets/img/assessment/gaya_desain/skandinavianRumah.jpg') ?>" alt="#" class="img-fluid" style="width: 220px;height: 85px;">
                    ...
                    <div class="col-md-4" style="max-width: 33%;"> 
                        <div class="custom-control custom-checkbox image-checkbox mt-4 gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd3">
                                <img src="<?= base_url('assets/img/assessment/gaya_desain/rumahIndustrial.jpg') ?>" alt="#" class="img-fluid" style="width: 220px;height: 85px;">
                        ...
                        <div class="custom-control custom-checkbox image-checkbox gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd6">
                                <img src="<?= base_url('assets/img/assessment/gaya_desain/rumahTradisional.jpg') ?>" alt="#" class="img-fluid" style="width: 220px;height: 85px;">
                        ...
                        <div class="custom-control custom-checkbox image-checkbox gaya_desain_cek">
                            ...
                            <label class="custom-control-label-b" for="check-gd9">
                                <img src="<?= base_url('assets/img/assessment/gaya_desain/rumahAsian.jpg') ?>" alt="#" class="img-fluid" style="width: 220px;height: 85px;">
        ...
        <fieldset>
          ...
          <div class="col-md-12 mt-4">
             <div class=" text-center">
                <h5>MATERIAL BANGUNAN</h5>
                <p style="font-size: 13px;">Pilihlah material bangunan untuk rumah tinggal Anda <br> pilih material bangunan untuk bagian Struktur, Lantai, Dinding, Plafon, Atap, Pintu dan Jendela </p>
             </div>
          <div class="row">
             <div class="col-md-12 scrollable-ma mt-3"> 
                <center>
                  <h5> Struktur</h5> <input type="checkbox" class="custom-control-input"  name="material[]" value="0" id="" checked hidden>
                  <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                      ...
                      <label class="custom-control-label-a" for="check-ma1">
                          <img src="<?= base_url('assets/img/assessment/material/struktur_beton_bertulang.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
                  ...
                  <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                      ...
                      <label class="custom-control-label-a" for="check-ma2">
                          <img src="<?= base_url('assets/img/assessment/material/struktur_baja.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
                  ...
                  <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                      ...
                      <label class="custom-control-label-a" for="check-ma3">
                          <img src="<?= base_url('assets/img/assessment/material/struktur_kayu.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
                          <center class="mt-2"> <label style="font-size: 13px;">Kayu</label> </center>
                      </label>
                  </div>
                </center>
             </div>
            <div class="col-md-12" style="background: #f8f8f8;padding: 13px;"> 
            <center><h5> Lantai</h5>
            <section class="pb-5">
                <div class="lantai">
                    <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                        ...
                        <label class="custom-control-label-a" for="check-ma4">
                            <img src="<?= base_url('assets/img/assessment/material/lantai_keramik.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
                    ...
                    <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                        ...
                        <label class="custom-control-label-a" for="check-ma5">
                            <img src="<?= base_url('assets/img/assessment/material/lantai_ht.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
                    ...
                    <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                        ...
                        <label class="custom-control-label-a" for="check-ma6">
                            <img src="<?= base_url('assets/img/assessment/material/lantai_vinyl.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
              ...
              <div class="dinding">
                  <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                      ...
                      <label class="custom-control-label-a" for="check-ma8">
                          <img src="<?= base_url('assets/img/assessment/material/dinding_cat.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
                  ...
                  <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                      ...
                      <label class="custom-control-label-a" for="check-ma9">
                          <img src="<?= base_url('assets/img/assessment/material/dinding_batu_alam.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
                  ...
                  <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                      ...
                      <label class="custom-control-label-a" for="check-ma13">
                          <img src="<?= base_url('assets/img/assessment/material/dinding_woodplank.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
          ...
          <div class="col-md-12 scrollable-ma" style="background: #f8f8f8;padding: 13px;"> 
              <center><h5> Plafon</h5>
              <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                  ...
                  <label class="custom-control-label-a" for="check-ma18">
                      <img src="<?= base_url('assets/img/assessment/material/plafon_gypsumboard.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
              ...
              <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                  ...
                  <label class="custom-control-label-a" for="check-ma19">
                      <img src="<?= base_url('assets/img/assessment/material/plafon_grc_board.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
              ...
              <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                  ...
                  <label class="custom-control-label-a" for="check-ma20">
                      <img src="<?= base_url('assets/img/assessment/material/plafon_pvc.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
          ...
          <div class="col-md-12 scrollable-ma mt-3"> 
              ...
              <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                  ...
                  <label class="custom-control-label-a" for="check-ma21">
                      <img src="<?= base_url('assets/img/assessment/material/atap_genteng.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
              ...
              <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                  ...
                  <label class="custom-control-label-a" for="check-ma22">
                      <img src="<?= base_url('assets/img/assessment/material/atap_galvalum.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
              ...
              <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                  ...
                  <label class="custom-control-label-a" for="check-ma23">
                      <img src="<?= base_url('assets/img/assessment/material/atap_dag_beton.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
          ...
          <div class="col-md-12 scrollable-ma" style="background: #f8f8f8;padding: 13px;"> 
              ...
              <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                  ...
                  <label class="custom-control-label-a" for="check-ma24">
                      <img src="<?= base_url('assets/img/assessment/material/pintujendela_kayu.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
                      <center class="mt-2"> <label style="font-size: 13px;">Kayu</label> </center>
                  </label>
              </div>
              <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                  ...
                  <label class="custom-control-label-a" for="check-ma25">
                      <img src="<?= base_url('assets/img/assessment/material/pintujendela_alumunium.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
              ...
              <div class="custom-control custom-checkbox image-checkbox mt-3 pl-rem col-md-2" style="float: left;min-width:33%">
                  ...
                  <label class="custom-control-label-a" for="check-ma26">
                      <img src="<?= base_url('assets/img/assessment/material/pintujendela_upvc.jpg') ?>" alt="#" class="img-fluid rounded-circle" style="width: 50px;height: 50px;">
...
<div class="container not-found" id="not-found" style="margin-top:13rem;margin-bottom: 15em;" hidden> 
   <div class="" style="width: 371px;margin:0 auto;">
      <img class="card-img-top" src="<?php echo base_url('assets/img/not_found_desain.png') ?>" alt="Card image cap">
      <div class="card-footer text-center c-nfound mt-3" style="width: 371px;border-top: 0;padding: 0">
        <span class="text-center">
            <a href="<?php echo base_url('desain') ?>" class="btn btn-success" style="width: 164px;border-radius: 0;">Lihat koleksi desain</a>
            <a href="https://web.whatsapp.com/send?phone=628112636228&text=Selamat%20Siang%0ASaya%20ingin%20bekonsultasi%20desain%20rumah%20dengan%20rumahtinggal.id%20" class="btn btn-danger" style="width: 197px;border-radius: 0;">Konsultasi dengan Kami</a>
        </span>
      </div>
   </div>
</div> 
...
<div id="hasil-assessment" class="container p-0" style="margin-top : 90px;">  
  ...
  <div>
    <div class="row mb-4" style="padding: 11px 0px;background: #3a658a05;box-shadow: 0px 2px 12px 2px #88888814;">
       <div class="item-filter mb-4" style="width: 66%;margin:0 auto;">
          <div class="item-title" style="text-align: center;">Biaya Konstruksi</div>
...
<div class="row">
        ...
        <div class="card-body text-center c-found mt-4 mb-5" style="background: #3a658a05;box-shadow: 0px 2px 12px 2px #88888814;">
            ...
            <p class="card-text"></p>
            <span class="text-center">
                <a href="https://web.whatsapp.com/send?phone=628112636228&text=Selamat%20Siang%0ASaya%20ingin%20bekonsultasi%20desain%20rumah%20dengan%20rumahtinggal.id%20" class="btn btn-danger">Konsultasi dengan Kami</a>
            </span>
        </div>
  ...
  let id_customer = Cookies.get('id_customer', { domain: 'rumahtinggal.id' });
               $.ajax({
                ...
                for (k = 0; k <= data.length-1;k++ ) {
                  let biaya = data[k].lantai == '1' ? 3500000 * data[k].luas_bangunan : ( data[k].lantai == '2' ? 4500000 * data[k].luas_bangunan : 5500000 * data[k].luas_bangunan );
                    $('#katalog-produk-filter').prepend(`<div class="col-md-5 p-0 grid">
                            <div class="product-grid">
                                <div class="product-image">
                                    <a href="javascript:void(0)" class="" onclick="detailRumah(`+data[k].id_rumah+`)">
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="product-detail">
                                        <p style="margin-bottom: auto;">Lahan minimal: <span style="font-weight: 400;">`+data[k].lebar_lahan+` m x `+data[k].panjang_lahan+` m</span></p>
