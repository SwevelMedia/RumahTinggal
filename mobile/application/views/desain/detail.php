<head> <meta name="viewport" content="width=360"></head>
<style>
...
.product-grid .product-statistic .share .fa {
   ...
   .list-produk-serupa .product-grid .product-statistic .view .fa {
        font-size: 15px !important;
        padding-right: 2px;
        margin-top: 2px;
    }
   .list-produk-serupa .product-grid .product-statistic .like .fa {
        font-size: 13px !important;
        padding-right: 2px;
        margin-top: 2px;
    }
   .list-produk-serupa .product-grid .product-statistic .share .fa {
        font-size: 14px !important;
        padding-right: 2px;
        margin-top: 2px;
    }
   ...
   .list-produk-serupa .product-grid .product-statistic .like span.value {
        font-size: 9px !important;
   ...
   .list-produk-serupa .product-grid .product-statistic .view, .list-produk-serupa  .product-grid .product-statistic .like {
        color: #000;
        padding-left: 0px;
    }

    .list-produk-serupa .slick-track .grid .product-grid .product-content .product-detail .product-statistic .statistic .btn-detail{
        padding: 1px 5px !important;
        font-size: 12px !important;
    }
    .list-produk-serupa .product-grid .product-image{
        height: 133px !important;
    }
    .list-produk-serupa .product-grid .title {
        font-size: 11px !important;
    }
    .list-produk-serupa .product-grid .arsitek{
        font-size: 10px !important;
        width: 53% !important;
    }
    .list-produk-serupa .product-grid .jstars::after{
        font-size: 9px !important;
    }
    .list-produk-serupa .product-grid .product-detail p{
        font-size: 9px !important;
    }
    .list-produk-serupa .btn-detail.favorit {
        padding: 2px 8px !important;
    }
    .list-produk-serupa .grid {
        height: 323px !important;
    }
    .list-produk-serupa .product-grid .title{
        height: 15px !important;
    }
    /*.list-produk-serupa .jstars .jstars-empty{
        font-size: 10px !important;
    }*/
    .list-produk-serupa .jstars{
        margin-top: -6px !important;
    }
    /*.list-produk-serupa .product-grid .product-feature .feature span {
        font-size: 10px !important;
    }*/
     .list-produk-serupa .product-grid .product-feature .feature img {
        width: 20px !important;
        height: 20px !important;
    }
    .list-produk-serupa .product-grid .product-rating{
        /*display: initial;*/
    }
    .list-produk-serupa .jstars .jstars-empty {
        font-size: 12px !important;
    }
    .list-produk-serupa .jstars .jstars-empty .jstars-filled {
        font-size: 12px !important;
    }
    ...
    .list-produk-serupa .product-grid .product-feature {
...
.btn.tanya-arsitek:hover { background: #ce9c05; }
...
#konsep::before, #spesifikasi::before {
...
.side-konsep .sec-biaya [data-tootik]::before { border-top-color: #ffbf00; }   
  
.side-konsep .sec-biaya [data-tootik]::after { background: #ffbf00; }
...
.side-konsep .card-group { margin-bottom: 10px; }
...
.side-konsep .card-group .sec-title { width: 83px; }   
...
.side-konsep #lantai1 .card-group .sec-spec{
    font-size: 14px;
}

.side-konsep #lantai2 .card-group .sec-spec{
    font-size: 14px;
}

.side-konsep .card-group .sec-spec sup { color: #000; }
...
.side-konsep .card-group .spec-tag:first-child { margin-left: 5px; }
...
#tabel-spesifikasi { font-size: 12px; }
...
#tabel-spesifikasi th, #tabel-spesifikasi td { padding: 2px 2px; }
...
.progress-bar { background-color: #ffe300 !important; }
  
.list-produk-serupa .product-grid { height: 390px; }  
.nav-tabs .nav-item {
    background: #E0EDF7;
    margin-right: 1px;
    margin-bottom: 0;
...
<div class="container mt-80 mb-40">
    <div class="row">
        <div class="col-md-12 p0">
            <h4 class="text-uppercase" id="nama_rumah"><?= $konsep->nama_rumah ?></h4>
            <p class="mb-0" style="font-size: 13px;">Didesain oleh <a href="<?= $this->config->item('url_mobile') ?>$konsep->id_arsitek" class="text-custom bold"><?= $konsep->nama_arsitek ?></a></p>
        </div>
        <div class="col-md-12 p0 mt-10" style="padding-right: 10px;">
            <ul class="nav nav-tabs" id="tab-desain" role="tablist">
    ...
    <div class="row">
        <div class="col-md-12 tab-content p0 mt-10 pl-0" >
                ...
                <div class="row mt-3" style="margin: 0;">
                   <!-- konsep -->
                    <div class="col-md-5 side-konsep">
                        ...
                        <div class="col-md-12 p-0" style="display: inline-block;max-width: 100%;">
                            ...
                            <span class="info-terjual"><i class="fa fa-info-circle text-custom" style="font-size: 14px;"></i> Didownload <?= $terjual ?> kali</span>



                            <div class="col-md-4 product-grid p-0" style="position: absolute;top: 16px;font-size: 11px;">
                        ...
                        <div class="row mt-15" style="font-size: 12px; margin-left: -18px;">
                            <div class="col-md-5 pr-0" style="max-width: 63%;flex: 0 0 63%;">
                            ...
                            <div class="col-md-4 p0" style="width: 37%;">
                                <div class="card-group">
                   ...
                   <div class="col-md-7">
                        ...
                        <p class="text-justify" style="font-size: 15px;"><?= $konsep_desain->konsep_desain ?></p>
                    </div>
                  <!-- konsep -->
            ...
            <div class="tab-pane fade mt-4" id="denah" role="tabpanel">
                <div class="row" style="margin: 0;">
                    <div class="col-md-12 p0 denah" id="foto-denah-lantai1">  
                        <div class="img-wrapper"><img id="foto-denah1" src="" class="image normal-zoom"></div>
                    </div>

                    <div class="col-md-12 p0 denah" id="foto-denah-lantai2" style="display: none;"> 
                        <div class="img-wrapper"><img id="foto-denah2" src="" class="image normal-zoom"></div>
                    </div>
                  
                    <div class="col-md-12 p0 denah" id="foto-denah-lantai3" style="display: none;"> 
                        <div class="img-wrapper"><img id="foto-denah3" src="" class="image normal-zoom"></div>
                    </div>

                    <div class="col-md-12 side-konsep" style="height: 295px;">
                      
                      
                      
                      <div class="col-md-12 p0 mb-3" style="display: inline-block; width: 96vw;">
                            <a class="btn btn-danger btn-beli-desain" href="<?= base_url('paket_pembelian/').$id_rumah ?>">Download Gratis</a>
                            <a class="btn tanya-arsitek" title="Tanya Desain" onclick="tanyaDesain()"><i class="fa fa-comments" style="font-size: 17px;"></i></a>
                            <span class="info-terjual"><i class="fa fa-info-circle text-custom" style="font-size: 14px;"></i> Didownload <?= $terjual->terjual ?> kali</span>

                            <div class="col-md-12 product-grid p0 p-0" style="position: absolute;top: 16px;font-size: 11px;">
                                <div class="product-statistic">
                                    <span class="view">
                                        <i class="fa fa-eye"></i><?= $konsep->dilihat ?>
                                    </span>
                        ...
                        <ul class="nav nav-tabs" id="tab-denah" role="tablist">
                            ...
                            <li class="nav-item" id="denah-lantai3" style="display: none;">
                                <a class="nav-link" data-toggle="tab" href="#lantai3" role="tab" aria-selected="false">Lantai 3</a>
                            </li>
                        ...
                        <div class="tab-content my-3" style="font-size: 15px;">
                            <div class="tab-pane fade active show" id="lantai1" role="tabpanel">
                                <div class="row" style="margin: 0; width: 93vw;"><div id="label-lantai1" class="col-md-12 p0 scrollable"></div></div>
                            </div>
                            <div class="tab-pane fade" id="lantai2" role="tabpanel">
                                <div class="row" style="margin: 0; width: 93vw;"><div id="label-lantai2" class="col-md-12 p0 scrollable"></div></div>
                            </div>
                            <div class="tab-pane fade" id="lantai3" role="tabpanel">
                                <div class="row" style="margin: 0; width: 93vw;"><div id="label-lantai3" class="col-md-12 p0 scrollable"></div></div>
                            </div>
                        </div>
            ...
            <div class="tab-pane fade" id="spesifikasi" role="tabpanel">
              ...
              <div id="carouselExampleControlsSpesifikasi" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="<?= base_url('assets/img/konsep/'.$konsep->foto) ?>" alt="First slide">
                  </div>
                ...
                <a class="carousel-control-prev" href="#carouselExampleControlsSpesifikasi" role="button" data-slide="prev">
                  <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                  <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#carouselExampleControlsSpesifikasi" role="button" data-slide="next">
                  <span class="carousel-control-next-icon" aria-hidden="true"></span>
                  <span class="sr-only">Next</span>
                </a>
              </div>
               ...
               <!-- <img class="d-block w-100" id="foto-rumah" src=""> -->
                <div class="card-group mt-4 side-konsep" style="background: transparent;padding: 0;height: 135px;">
                    <div class="col-md-12 p0" style="margin-top: -5px; font-size: 15px;">
                        <h5 class="bold">Palet Material</h5>
                        Berisi informasi material yang digunakan dalam desain ini
                    </div>
                    <div class="col-md-12 p0" style="display: inline-block;">
                        <a class="btn btn-danger btn-beli-desain" href="<?= base_url('paket_pembelian/').$id_rumah ?>">Download Gratis</a>
                        <a class="btn tanya-arsitek" title="Tanya Desain" onclick="tanyaDesain()"><i class="fa fa-comments" style="font-size: 17px;"></i></a>
                        <span class="info-terjual"><i class="fa fa-info-circle text-custom" style="font-size: 14px;"></i> Didownload <?= $terjual->terjual ?> kali</span>

                         <div class="col-md-12 product-grid p0" style="position: absolute;top: 16px;font-size: 11px;">
                        <div class="product-statistic">
                            <span class="view">
                                <i class="fa fa-eye"></i><?= $konsep->dilihat ?>
                            </span>
                ...
                <div class="mt-4 ml-2 mr-2" style="font-size: 15px;">
                    <h5 class="bold">Tabel Spesifikasi Teknis</h5>
                    ...
                    <table id="tabel-spesifikasi" class="table table-bordered table-hover table-striped mt-3 mb-0">
                        <thead>
                            <tr>
                              ...
                              <th scope="col"  style="width: 4%;">Pekerjaan</th>
                              <th scope="col"  style="width: 4%;">Material</th>
                              <th scope="col" style="width: 4%;">Spesifikasi</th>
                              <th scope="col" style="width: 4%;">Merk</th>
                            </tr>
                        </thead>
...
<section class="banner-area relative" style="height: 385px;">
    <div class="overlay">
        <img src="<?= base_url('assets/img/header-bg.jpg') ?>" style="height: 385px;width: 100%;filter: brightness(20%);">
    </div>
    ...
    <div class="container" id="ulasan-nfound" style="position: absolute;top: 28px;width: 100%;">
    ...
    <div class="container" id="ulasan-found" style="display: none;position: absolute; top: 28px; width: 100%;padding-right: 15px !important;">
        <div class="row">

            <div class="col-md-6" style="color: #fff;flex: 0 0 67%;">
                <h5 style="margin-bottom: 10px;color: #fff;">Ringkasan Ulasan</h5>
                <div class="pull-left">
                    <div class="pull-left" style="width:20px; line-height:1;">
                        <div style="height:9px; margin:0px 0;font-size: 12px;">5</div>
                    </div>
                    <div class="pull-left" style="width:135px;">
                        <div class="progress" style="height:7px; margin:4px 0;">
                ...
                <div class="pull-left">
                    <div class="pull-left" style="width:20px; line-height:1;">
                        <div style="height:9px; margin:0px 0;font-size: 12px;">4</div>
                    </div>
                    <div class="pull-left" style="width:135px;">
                        <div class="progress" style="height:7px; margin:4px 0;">
                ...
                <div class="pull-left">
                    <div class="pull-left" style="width:20px; line-height:1;">
                        <div style="height:9px; margin:0px 0;font-size: 12px;">3</div>
                    </div>
                    <div class="pull-left" style="width:135px;">
                        <div class="progress" style="height:7px; margin:4px 0;">
                ...
                <div class="pull-left">
                    <div class="pull-left" style="width:20px; line-height:1;">
                        <div style="height:9px; margin:0px 0;font-size: 12px;">2</div>
                    </div>
                    <div class="pull-left" style="width:135px;">
                        <div class="progress" style="height:7px; margin:4px 0;">
                ...
                <div class="pull-left">
                    <div class="pull-left" style="width:20px; line-height:1;">
                        <div style="height:9px; margin:0px 0;font-size: 12px;">1</div>
                    </div>
                    <div class="pull-left" style="width:135px;">
                        <div class="progress" style="height:7px; margin:4px 0;">
            ...
            <div class="col-md-12 p0 mt-3">
                <div class="row scrollable mb-3" id="list-ulasan" style="max-height: 11em;width: 323px;color: #fff;margin-left: 1px;"></div>
                <button class="btn btn-custom btn-tulis-ulasan" data-toggle="modal" data-target="#modalTulisUlasan" style="padding: 4px 6px; font-size: 14px;">Tulis Ulasan</button>
            </div>
        </div>
    </div>
</section>

<section class="mt-35" style="width: 100vw;">
  <div class="container p0">
      <div class="row" style="width: 104vw;">
          <div class="col-md-12">
              <center>
...
<script>
    var id_rumah, tab_denah_load = 0, tab_spek_load = 0, id_customer;
                            ...
                            $.each(data, function(i, item) {
                                ...
                                $('.palet_material').append(`<div class="col-md-2">
                                    <center>
                                        ...
                                        <span style="font-size:14px;">`+item.material+`</span>
                                    </center>
                                </div>`);
                            });
        ...
        $.ajax({
            ...
            success: function(data){
                if (data != '') {
                    ...
                    $('.review-block-rating').jsRapStar({enabled: false});
                    $('#ulasan-found').show();
                    $('#ulasan-nfound').hide();
                }
            },
