...
<footer class="footer-area" style="padding-left: 15px;">
	<div class="container">
		<div class="row" style="width: 345px !important;">
			<div class="col-lg-6 col-md-6 col-sm-6 p0 mo-footer">
				<div class="single-footer-widget">
					<h4>Tentang Kami</h4>
					<div class="line-footer"></div>
					<p style="width: 90%;font-size: 11px;">
						RumahTinggal.id merupakan marketplace desain rumah untuk mewujudkan hunian idaman Anda, dapatkan desain hunian terbaik dengan mudah, hemat, dan berkualitas 
					</p>
					<p style="margin-bottom: 0">

						<ul class="menu bottomRight" id="bottomRight">
						  <li class="share top" onclick="">
						    <i class="fa fa-phone"></i>
						    <ul class="submenu">
						      <li> <a href="https://www.facebook.com/rumahtinggal.id/" target="_blank" class="facebook"><i class="fa fa-facebook i-con-footer" aria-hidden="true"></i></a></li>
						      <li><a href="https://www.instagram.com/rumahtinggal_id/" target="_blank" class="instagram"><i class="fa fa-instagram i-con-footer" aria-hidden="true"></i></a></li>
						      <li><a href="https://twitter.com/rumahtinggal_id" target="_blank" class="twitter"><i class="fa fa-twitter i-con-footer" aria-hidden="true"></i></a></li>
						      <li><a href="https://api.whatsapp.com/send?phone=628112636228&text=Hai%20rumahtinggal.id%2C%20saya%20ingin%20bertanya%20mengenai%20desain%20rumahtinggal.id%20" target="_blank" class="whatsapp"><i class="fa fa-whatsapp i-con-footer" aria-hidden="true"></i></a> </li>
						      <li><a href="https://id.pinterest.com/rumahtinggalid" target="_blank" class="pinterest"><i class="fa fa-pinterest i-con-footer" aria-hidden="true"></i></a></li>
						      <li> <a href="https://mail.google.com/mail/?view=cm&fs=1&to=mail.rumahtinggal@gmail.com&su=Tanya rumahtinggal.id&body=Hai rumahtinggal.id, saya ingin bertanya mengenai desain di rumahtinggal.id" target="_blank" class="mail"><i class="fa fa-envelope i-con-footer" aria-hidden="true"></i></a></li>
						    </ul>
						  </li>
						</ul>
    ...
    <div class="col-md-12 text-center" style="background: #026CB6;color: #fff;font-size: 15px;line-height: 40px;height: 40px;width: 360px;margin-left: -15px">
...
<!-- div class="" style="background: #026cb6; height: 2em;">
...
window.onload = function () {
    ...
    if (screen.width > 1279) {
      ...
      // load_content_banner();
    // }, 2);
     // document.querySelectorAll('.ph-item-banner').forEach(e => e.remove());
     // $('.ph-item-banner').remove();
    	 var mvp = document.getElementById('myViewport');
    ...
    $('.flickity-page-dots .dot').addClass('dot-mo');
     ...
     if (Cookies.get('id_customer', { domain: 'rumahtinggal.id/mobile/' }) == null) {
        // window.onload = function () {
