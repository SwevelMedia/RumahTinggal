...
.product-grid .product-statistic .share .fa {
   ...
   #desain .product-grid .product-statistic .view .fa,#desain_filter .product-grid .product-statistic .view .fa {
        font-size: 15px !important;
        padding-right: 2px;
        margin-top: 2px;
    }
   #desain .product-grid .product-statistic .like .fa,#desain_filter .product-grid .product-statistic .like .fa {
        font-size: 13px !important;
        padding-right: 2px;
        margin-top: 2px;
    }
   #desain .product-grid .product-statistic .share .fa,#desain_filter .product-grid .product-statistic .share .fa {
        font-size: 14px !important;
        padding-right: 2px;
        margin-top: 2px;
    }
   #desain .product-grid .product-statistic .view, #desain_filter .product-grid .product-statistic .view {
        font-size: 9px !important;
       
    }
   #desain .product-grid .product-statistic .like span.value,#desain_filter .product-grid .product-statistic .like span.value {
        font-size: 9px !important;
   ...
   #desain .product-grid .product-statistic .view, #desain  .product-grid .product-statistic .like,#desain_filter .product-grid .product-statistic .view, #desain_filter  .product-grid .product-statistic .like {
        color: #000;
        padding-left: 0px;
    }

    #desain .grid .product-grid .product-content .product-detail .product-statistic .statistic .btn-detail,#desain_filter .grid .product-grid .product-content .product-detail .product-statistic .statistic .btn-detail{
        padding: 1px 5px !important;
        font-size: 12px !important;
    }
    #desain .product-grid .product-image,#desain_filter .product-grid .product-image{
        height: 133px !important;
    }
    #desain .product-grid .title,#desain_filter .product-grid .title {
        font-size: 11px !important;
    }
    #desain .product-grid .arsitek,#desain_filter .product-grid .arsitek {
        font-size: 10px !important;
        width: 53% !important;
    }
    #desain .product-grid .jstars::after, #desain_filter .product-grid .jstars::after{
        font-size: 9px !important;
    }
    #desain .product-grid .product-detail p,#desain_filter .product-grid .product-detail p{
        font-size: 9px !important;
    }
    #desain .btn-detail.favorit,#desain_filter .btn-detail.favorit {
        padding: 2px 8px !important;
    }
    #desain .grid,#desain_filter .grid {
        height: 238px !important;
    }
    #desain .product-grid .title, #desain_filter .product-grid .title{
        height: 15px !important;
    }
    /*#desain .jstars .jstars-empty{
        font-size: 10px !important;
    }*/
    #desain .jstars, #desain_filter .jstars{
        margin-top: -6px !important;
    }
    /*#desain .product-grid .product-feature .feature span {
        font-size: 10px !important;
    }*/
    #desain .product-grid .product-feature .feature img, #desain_filter .product-grid .product-feature .feature img {
        width: 20px !important;
        height: 20px !important;
    }
    #desain .product-grid .product-rating, #desain_filter .product-grid .product-rating{
        /*display: initial;*/
    }
    #desain .jstars .jstars-empty,#desain_filter .jstars .jstars-empty {
        font-size: 12px !important;
    }
    #desain .jstars .jstars-empty .jstars-filled,#desain_filter .jstars .jstars-empty .jstars-filled {
        font-size: 12px !important;
    }
    
    #desain .product-grid .product-feature .feature span,#desain_filter .product-grid .product-feature .feature span {
        font-size: 8px !important;
    }
    #desain .product-grid,#desain_filter .product-grid {
        margin: 0 5px !important;
        /*width: 170px;*/
    }
    #desain .product-grid .product-feature,#desain_filter .product-grid .product-feature {
...
<section class="offered-area section-gap" id="offered" style="margin-top: 3em;">
<div class="container" style="padding-right: 15px !important;">
    <div class="row">
      	<div class="col-lg-12">
            <img src="<?php echo base_url().'assets/img/arsitek/'.$arsitek[0]->foto ?>" style="width: 90px;border-radius: 100%;">
            <h3 class="nama_arsitek mb-2" style="position: absolute;top: 30px;left: 115px;font-weight: 800;color: #000;"><?php echo $arsitek[0]->nama_arsitek ?></h3>
            <!-- <div style="width: 360px;position: absolute;z-index: -1;left: -9px;top: -103px;height: 153px;background-image:url('<?php echo base_url().'assets/img/arsitek/'.$arsitek[0]->foto ?>'); background-size: cover;-webkit-filter: blur(5px);filter: blur(5px);"></div> -->
		</div>
        <div class="col-lg-12 black mt-3">
        	<!-- <h2 class="nama_arsitek mb-2" style="font-weight: 500;"><?php echo $arsitek[0]->nama_arsitek ?></h2> -->
        	<p class="text-justify"><?php echo $arsitek[0]->profil ?></p>
    	    <div class="row">
    		    <div class="col-lg-6">
                    <div class="">
        ...
        <li><a href="https://www.instagram.com/<?php echo $arsitek[0]->instagram ?>/" target="_blank"><i class="fa fa-instagram f-size15"></i></a></li>
        <li><a href="https://www.facebook.com/<?php echo $arsitek[0]->facebook ?>/" target="_blank"><i class="fa fa-facebook f-size15"></i></a></li>
...
<div class="mt-3" style="background: #026CB6; line-height: 35px;"> <h3 style="color: #fff;line-height: 35px !important" class="text-center">PORTOFOLIO</h3> </div>
...
<div class="container mb-5" style="padding-right: 15px !important;">
<div class="row">
<div id="desain_terbangun" class="col-md-12 column terbangun" style="padding-left: 0px;-ms-overflow-style: none;overflow-y: scroll;height: 480px;" >
<?php foreach($portofolio as $item) : ?> 
<div class="col-md-6 p0 grid" style="float: left; width: 50%;">
    <figure class="snip1361 white">
        <img src="<?= base_url().'assets/img/portofolio/'.$item->foto ?>" alt="portofolio" />
        <figcaption>
            <h6 class="white" style="font-weight: 400;font-size: 11px;"><?= $item->judul ?></h6>
            <p><?= $item->kategori ?></p> <hr style="margin: 0 !important;background:#fff;"><p>
                <div class="card-group">
                    <div style="width: 30%;"><span>Klien</span></div>
                    <div style="width: 70%;"><span>:</span><span style="margin-left: 5px;"><?= $item->klien ?></span></div>
                </div>
                <div class="card-group">
                    <div style="width: 30%;"><span>Lokasi</span></div>
                    <div style="width: 70%;"><span>:</span><span style="margin-left: 5px;"><?= $item->lokasi ?></span></div>
                </div>
                <div class="card-group">
                    <div style="width: 30%;"><span>Tahun</span></div>
                    <div style="width: 70%;"><span>:</span><span style="margin-left: 5px;"><?= $item->tahun ?></span></div>
                </div>
                <div class="card-group">
                    <div style="width: 30%;"><span>Status</span></div>
                    <div style="width: 70%;"><span>:</span><span style="margin-left: 5px;"><?= $item->status ?></span></div>
                </div>
            </p>
        </figcaption>
        <!-- <a href="#"></a> -->
...
<div id="desain_terbangun_filter" class="col-md-12 column terbangun" style="padding-left: 0px;-ms-overflow-style: none;overflow-y: scroll;height: 480px;"></div>

<div id="desain" class="col-md-12 column desain" style="-ms-overflow-style: none;overflow-y: scroll;height: 711px;">
...
<div id="desain_filter" class="col-md-12 column desain" style="-ms-overflow-style: none;overflow-y: scroll;height: 711px;"></div>
</div>
</div>
...
// <?= $this->config->item('url_mobile') ?>profil_arsitek
         ...
         $.ajax({
           ...
           success: function(data){
               ...
               for (k = 0; k <= data.length-1;k++ ){
                    $('#desain_filter').append(`<div class="col-md-6 p0 grid" style="float:left;width: 50%;">
                        <div class="product-grid">
        ...
        $.ajax({
           ...
           success: function(tes){
               ...
               for (var k = 0; k <= tes.length-1;k++ ){
                    $('#desain_terbangun_filter').append(`<div class="col-md-6 grid" style="float: left; width: 50%;">
                        <figure class="snip1361 white">

                            <img src="<?php echo base_url() ?>assets/img/portofolio/`+tes[k].foto+`" alt="portofolio">
                            <figcaption>
                                <h6 class="white" style="font-weight: 400;font-size: 11px;">`+tes[k].judul+`</h6>
