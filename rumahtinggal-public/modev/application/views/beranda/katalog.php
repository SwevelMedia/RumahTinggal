...
<div class="owl-carousel owl-theme" id="owl-carousel-banner"  style="margin-top: -15px;width: 360px;">
    ...
    <div class="item"><img src="<?= base_url('assets/img/dev/B-02.jpg') ?>" class="d-block w-100" style="height: 240px;" /></div>
    <div class="item"><img src="<?= base_url('assets/img/dev/B-05.jpg') ?>" class="d-block w-100" style="height: 240px;" /></div>
    <div class="item"><img src="<?= base_url('assets/img/dev/B-04.jpg') ?>" class="d-block w-100" style="height: 240px;" /></div>
</div>
</section>
                    ...
                    <div style="text-align: center;color: #055993;font-size: 18px; font-weight: 600;line-height: 18px;"> 5 Cara Mudah Dapatkan Desain Murah </div>
                        <div class="owl-carousel owl-theme" id="owl-carousel-rule" style="margin-bottom: 75px;height: 290px;">
                            ...
                            <div class="scnd text-center item">
                                ...
                                <p style="font-size: 12px;line-height: 16px;">Untuk mendapatkan desain rumah tinggal sesuai kebutuhan, lakukan <a href="<?= base_url('assessment') ?>"  style="color: #026CB6;text-decoration: none;">assessment</a> atau filter desain pada halaman <a href="<?= base_url('desain') ?>"  style="color: #026CB6;text-decoration: none;">koleksi desain</a>
                                </p>
                            </div>
                            ...
                            <div class="frst text-center item">
                                ...
                                <p style="font-size: 12px;line-height: 16px;"><a href="<?= base_url('sampel_desain') ?>"  style="color: #026CB6;text-decoration: none;">Paket desain</a> akan dikirim dalam bentuk softfile ke Whatsapp dan email, serta hardfile (print out) ke alamat Anda
                                </p>
                            </div>
                        </div>
    ...
    <div class="modal-dialog animated tada" style="z-index: 2;width: 555px;">
        <div class="modal-content" style="background: transparent;box-shadow: none;border: none;">
            <div class="modal-body" style="text-align: center;">
                ...
                <img src="<?php echo base_url('assets/img/pop_up/pop_up_ga_2.png') ?>" width="350px;" class="pop-up-website">
                <button class="btn btn-danger btn-pop-up btn-konsultasi" onclick="window.open('http://bit.ly/giveaway72jt','_blank')" style="padding: 5px 11px;margin-top: -273px;font-size: 21px;border-radius: 25px;background: red;border-color: red;box-shadow: 0px 3px 5px 5px rgba(38, 38, 38, 0.19),0px 2px 2px 1px rgba(184, 184, 184, 0.45);">Daftar Sekarang</button>
            </div>
        </div>
    </div>
</div>
...
// }
    ...
    function material(){
        location.href = "<?= $this->config->item('url_desktop') ?>material";
