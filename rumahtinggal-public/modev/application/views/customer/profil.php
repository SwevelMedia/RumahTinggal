               ...
               <div class="user-box">
                   <div class="left pUtama" id="left">
                    <center>
                     <?php
                        if ($profil->foto != "") {
                          echo '<img id="default-foto" alt="" style="width:111px;height: 111px;" src=" https://rumahtinggal.id/assets/img/customer/'.$profil->foto.'" class="img-thumbnail" />';}else{echo ' <img id="default-foto" alt="" style="width:111px;height: 111px;" src="https://cdn-a.shopicial.com/img/noavatar.png" class="img-thumbnail" />';} 
                     ?> 
                        <br>
                                ...
                                <article class="card fl-left" style="display: table-row;width: 100%;background-color: #c6d9e566;color: #525252;margin-bottom: 10px;border-radius: 4px;position: relative;overflow: hidden;">
                                  ...
                                  <section class="card-cont">
                                    ...
                                    <?php
                                        if ($trns->status == "1" || $trns->status == "2") {
                                          echo '';}else{echo '<div class="mt-2 bold">Batas Pembayaran</div>
                                    ...
                                    <?php
                                    if ($trns->status == "0") {
                                      echo '<a href="#" style="font-weight: 600;background-color:#f70000;pointer-events: none;font-size:15px;">Belum Bayar</a>';}else if ($trns->status == "2"){echo '<a href="#" style="font-weight: 600;background-color:#00a903;pointer-events: none;font-size:15px;">Lunas</a>';}else{echo '<a href="#" style="font-weight: 600;background-color:#00a903;pointer-events: none;font-size:15px;">Lunas</a>';} 
                                    ?> 
                                  </section>
                                  ...
                                  <div class="btn-demo" id="btn-color-targets">                                  
                                    <?php
                                        ...
                                        }else if ($trns->status == "2") {echo '<div style="position: absolute;color: #fff;top: 150px;right: 13px;font-weight: 400;width: 171px;text-align: center;cursor: unset;font-size: 12px;border: 1px solid #ff9b00;background:#ff9b00;height: 31px;line-height: 28px;">Sedang Diproses</div>';}else {echo '<a href="#modalKonfirmasiPaketDiterima'.$trns->id_rumah.'" data-target-color="green" data-toggle="modal" class="btn btn-default " style="position: absolute;color: #fff;top: 150px;right: 13px;font-weight: 500;background: #00a903;padding: 9px;width: 171px;text-align: center;cursor: pointer;border-radius: 5px;font-size: 12px;">Konfirmasi Paket Diterima</a>';}
                                    ?> 
                                  </div>                                    
                                </article>
                              </div>
    ...
    foto_paket.on("complete", function(file){
        ...
        $('.dropzone .dz-preview .dz-image img[alt="'+images.first().val()+'"]').parent().addClass('aktif icon');
                ...
                <div class="tab-pane active show" id="messages" style="/*scrollbar-width: none;-ms-overflow-style: none;overflow-y: scroll;height: 41em;*/">
                    <div class="alert alert-info alert-dismissible p-2" role="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                        <!-- <div class="alert-icon">
                            <i class="icon-info"></i>
                        </div> -->
                        <div class="alert-message" style="font-size: 12px;">
    ...
    $.ajax({ 
        ...
        success: function(data){
            ...
            $.each(data, function(i, item) {
                $('#dokumen').append(`<div class="col-md-12 p0 grid"  style="height: 65px;margin-bottom: 1em;">
                          ...
                          <div style="height: auto;position: absolute;" class="col-md-3 product-image desain">
                            ...
                            <div class="product-detail">
                               <table class="table table-hover">
                                    ...
                                    `+ (item.paket ==1 ? `<tr>
                                            <td> 
                                               <span class="float-right font-weight-bold" style="padding: 0px;"> <a href="<?= base_url('assets/dokumen/') ?>`+item.laporan_desain+`">Download</a></span> <img class="palet-img" style="width: 25px;" src="https://rumahtinggal.id/assets/img/pdf.png"> Laporan Desain
                                            </td>
                                        </tr>`: `<tr>
                                            <td> 
                                               <span class="float-right font-weight-bold" style="padding: 0px;"> <a href="<?= base_url('assets/dokumen/') ?>`+item.laporan_desain+`">Download</a></span> <img class="palet-img" style="width: 25px;" src="https://rumahtinggal.id/assets/img/pdf.png"> Laporan Desain
