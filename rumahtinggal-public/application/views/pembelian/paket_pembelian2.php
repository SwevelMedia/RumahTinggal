...
#gSignIn .abcRioButton.abcRioButtonBlue { margin: 0 auto; }
...
.fa.fa-question-circle-o { color: #026CB6; }
...
.tool-tip .tool-tip__info .info__title { color: #009f04; }
...
.tool-tip .tool-tip__info span { color: #fff; }
...
[aria-label][data-balloon-pos]::after { background: rgba(31, 159, 5, 0.95); }
  
[aria-label][data-balloon-pos]::before { border-top-color: rgba(31, 159, 5, 0.95); }
...
.pricingTable .price-value { text-align:center; }
...
.pricingTable.header .pricing-content ul li { text-align: left; }
...
.pricingTable .read:hover, .pricingTable.free .read:hover { background: linear-gradient(to right,#f7b927,#ec8920); }
  
/*.pricingTable.free .pricingTable-header, .pricingTable.free .read { background: #026CB6; }*/

.pricingTable.free .amount { background: transparent; }
  
/*.pricingTable.free .round-bottom { background: #026CB6; } */

.pricingTable.free .read { background: linear-gradient(to right,#d9201a,#fb3a30); /*background: linear-gradient(to right,#ec8920,#f7b927);*/ }
...
.pricingTable li { text-align: left; }
...
.tabel-centang, .tabel-centang-material {
    text-align: left;
    padding: 0px 45px;
}
</style>
  ...
  <div class="row" style="margin-top: 25px;margin-bottom: 25px;">
      ...
      <div class="col-md-2 col-sm-6 text-center" style="padding: 0;">
          <span class="subtitle text-center pricingTable professional-button">
              <a href="<?= base_url('checkout/1/').$id_rumah ?>" onclick="checkoutProfesional()" class="read order">Beli</a>
          </span>
      </div>

      <div class="col-md-2 col-sm-6 text-center" style="padding: 0;">
          <span class="subtitle text-center pricingTable free corporate-button">
              <a href="<?= base_url('checkout/2/').$id_rumah ?>" onclick="checkoutCorporate()" class="read order">Beli</a>
          </span>
      </div>
    
     <div class="col-md-2 col-sm-6 text-center" style="padding: 0;">
          <span class="subtitle text-center pricingTable corporate-button">
              <a href="<?= base_url('checkout/3/').$id_rumah ?>" onclick="checkoutCorporate()" class="read order">Beli</a>
          </span>
      </div>
              ...
              <div class="entry-box pull-right" style="right: 22px;top: 22px;width: 255px;position: absolute;">
                  ...
                  <div class="form-group text-center" id="sec-akses-sso">
                      ...
                      <!-- <ul class="list-inline">
                          ...
                          <li class="hvr-float-shadow"><a href="<?php if (isset($auth_google)) echo $auth_google; else echo 'javascript:void(0);' ?>" id="link-sso-google"><div class="g"></div></a></li>
                      </ul> -->
                      <div id="gSignIn"></div>
                  </div>
              </div>
