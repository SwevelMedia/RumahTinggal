        ...
        <div id="sec-invoice" style="min-width: 600px">
                ...
                <div class="row">
                    <div class="col">
                        <a target="_blank" href="<?= base_url() ?>">
                            <img src="<?= base_url('assets/img/logo.png') ?>" width="90px" data-holder-rendered="true" />
                        </a>
                    </div>
                </div>
            </header>
      	...
      	<div class="toolbar hidden-print">
            <div class="text-right">
                <a href="<?= base_url('cetak_invoice/').$no_invoice ?>"><button class="btn btn-custom" id="btn-download"><i class="fa fa-file-pdf-o"></i> Download</button></a>
            </div>
        </div>
    </div>
</div>