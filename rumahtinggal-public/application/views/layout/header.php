...
http://css3-mediaqueries-js.googlecode.com/svn/trunk/css3-mediaqueries.js"></script>
  	<style>
        ...
        @font-face {
      	...
      	p span strong { color: #000; }
      
      	.card-title a:hover { color: #05bcd2 !important; }
      
      	.round { border-radius: 3px; }
      
        .tag { background: none !important; }
      
        .tag:hover { background: #026CB6 !important; }
      
      	.i-heart { margin-right: 6px; }
      
        .i-heart:hover { color: #ff0101; }
        
      	.fa-share-alt:hover { color:#05bcd2; }
        ...
        .product-grid .product-statistic .social a:hover i { color: #fff; }
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-189297311-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-189297311-1');
    </script>
</head>