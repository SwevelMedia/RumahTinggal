        ...
        <div class="row">
            <div class="col-md-3 bg-side">
                <div style="box-shadow: 0px 2px 3px 2px #d7d7d7;padding: 16px 6px;border-radius: 14px;background: #026CB61C;margin-top: 17px;">
                    ...
                    <p class="center" style="color: #000;margin-bottom: 10px;font-size:13px;">Temukan desain rumah tinggal yang tepat<br>melalui fitur asesmen</p>
            ...
            ` + promo + `
                ...
                <div class="product-content">
                    ...
                    <div class="product-detail">
                        ...
                        <p>Biaya konstruksi <span style="font-weight: 400;" data-tootik="Estimasi awal" data-tootik-conf="square">` + number_format(biaya, 0, ',', '.') + `</span></p>
