...
<div class="gallery js-flickity gallery-mo" id="gallery" data-flickity-options='{"fade": true}' style="margin-top: -15px;width: 366px;display: none;">
...
<div class="container mt-5 gallery-dev" style="background-image: url(<?= base_url('assets/img/banner/new/banner_background_atas.png') ?>);width: 100%;background-repeat: no-repeat;background-size: 100%;">
    <div class="row">
        <div class="col-md-5">
            <div style="margin-top: 65px; padding:0px 15px;">
                <div>
                    <h1 style="font-size: 42px;color: #026cb6;background: #fff;padding: 3px 15px;width: 355px;border-radius: 10px;font-weight: 500;">RumahTinggal.id</h1>
                </div>
                ...
                <button class="btn btn-danger mt-4 text-white" onclick="assessment()" style="padding: 5px 9px;background: #f00; margin-top: 25px;">Mulai Sekarang</button>
                <button class="btn btn-warning mt-4 ml-1 text-white" onclick="lihatKoleksi()" style="padding: 5px 9px;color: #fff;margin-top: 25px;">Lihat Koleksi</button>
            </div>
        </div>
        <div class="col-md-7">
            <div class="gallery js-flickity" id="gallery" data-flickity-options='{ "fade": true, "autoPlay": 4500, "pauseAutoPlayOnHover": true }' style="margin-top: 21px;height: 320px;">

                <div class="gallery-cell">
                    <a href="<?= base_url('desain#promo') ?>">
                        <img src="<?= base_url('assets/img/banner/new/banner_promo.png') ?>" class="d-block w-100" style="height: 255px;" />
                    </a>
                </div>
                <div class="gallery-cell">
                    <a href="<?= base_url('sampel_desain') ?>">
                        <img src="<?= base_url('assets/img/banner/new/banner_lite_premium.png') ?>" class="d-block w-100" style="height: 255px;" />
                    </a>
                </div>
                <div class="gallery-cell">
                    <a href="<?= base_url('detail-artikel/5') ?>">
                        <img src="<?= base_url('assets/img/banner/new/banner_jangan_bangun_rumah.png') ?>" class="d-block w-100" style="height: 255px;" />
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 text-center p-0 mb-2 mt-3">
            <div class="px-0 pt-1 pb-0 mb-3">
                <div class="container cara-kerja-mo" style="padding-right: 15px !important;padding-left: 0px !important;width: 550px;">
                    <div style="text-align: center;color: #055993;font-size: 29px; font-weight: 600;line-height: 18px;margin-top: 19px;">
                    ...
                    <div class="slider" id="carousel-mo" style="margin-bottom: 60px;height: 308px;">
                        <div class="frst text-center">
                            <div style="width: 100%;height: 180px;">
                                <img class="fielmo mb-4 mt-4" style="width: 250px; height: 148px;" src="<?= base_url('assets/img/dev/CKerja_1.png') ?>">
                            </div>
                            <h3 style="text-align: center;">Kunjungi Website</h3>
                            <p style="font-size: 19px;line-height: 22px;text-align: center;">
                                Kunjungi Website <a href="<?= base_url() ?>" style="color: #026CB6;text-decoration: none;">rumahtinggal.id</a>, Anda akan menemukan fitur Temukan Desain dan Lihat Koleksi pada halaman muka.
                            </p>
                        </div>
                        <div class="scnd text-center">
                            <div style="width: 100%;height: 180px;">
                                <img class="fielmo mb-4 mt-4" style="width: 250px; height: 148px;margin-top: 25px;" src="<?= base_url('assets/img/dev/CKerja_2.png') ?>">
                            </div>
                            <h3 style="text-align: center;">Assessment / Filter</h3>
                            <p style="font-size: 19px;line-height: 22px; text-align: center;">
                                Untuk mendapatkan desain rumah tinggal sesuai kebutuhan, lakukan <a href="<?= base_url('assessment') ?>" style="color: #026CB6;text-decoration: none;">assessment</a> atau filter desain pada halaman <a href="<?= base_url('desain') ?>" style="color: #026CB6;text-decoration: none;">koleksi desain</a>
                            </p>
                        </div>
                        <div class="thrd text-center">
                            <div style="width: 100%;height: 180px;">
                                <img class="fielmo mb-4 mt-4" style="width: 195px; height: 148px;" src="<?= base_url('assets/img/dev/CKerja_3.png') ?>">
                            </div>
                            <h3 style="text-align: center;">Pilih Desain</h3>
                            <p style="font-size: 19px;line-height: 22px; text-align: center;">
                                Pilih desain keinginan. Pelajari lebih lanjut desain yang Anda pilih. Jika ada pertanyaan klik tombol <i class="fa fa-comments" style="font-size: 17px;color: #fff;background: #fab700;padding: 2px 3px 4px 3px;border-radius: 4px;"></i>
                            </p>
                        </div>
                        <div class="frth text-center">
                            <div style="width: 100%;height: 180px;">
                                <img class="fielmo mb-4 mt-4" style="width: 195px; height: 148px;" src="<?= base_url('assets/img/dev/CKerja_4.png') ?>">
                            </div>
                            <h3 style="text-align: center;">Pembayaran</h3>
                            <p style="font-size: 19px;line-height: 22px; text-align: center;">
                                Apabila Anda sudah yakin dengan pilihan desainnya, lakukan pembayaran, dengan cara klik tombol <span style="color: #fff;background: #e10505;padding: 3px 6px;font-weight: 400;border-radius: 5px;">Beli Desain</span>. Ikuti petunjuk pembayaran
                            </p>
                        </div>
                        <div class="frst text-center">
                            <div style="width: 100%;height: 180px;">
                                <img class="fielmo mb-4 mt-4" style="width: 250px; height: 148px;" src="<?= base_url('assets/img/dev/CKerja_5.png') ?>">
                            </div>
                            <h3 style="text-align: center;">
                                <strong>Pengiriman Desain</strong>
                            </h3>
                            <p style="font-size: 19px;line-height: 22px; text-align: center;">
                                <a href="<?= base_url('sampel_desain') ?>" style="color: #026CB6;text-decoration: none;">Paket desain</a> akan dikirim dalam bentuk softfile ke Whatsapp dan email, serta hardfile (print out) ke alamat Anda
                            </p>
                        </div>
                    </div>
        ...
        <div class="col-md-6" id="video-dev" style="text-align: center;margin-top: 38px;">
            ...
            <video id="my-video" class="video-js vjs-matrix" controls preload="auto" width="620" height="350" poster="https://rumahtinggal.id/assets/img/thumbnail_website.png" data-setup="{}">
...
<section class="pb-4">
    <div class="container">
        <div class="row banner-slider mobile-promo" style="background-image: url(<?= base_url('assets/img/dev/BPromo.jpg') ?>);">
            <div id="lihat-promo-mo" style="position: absolute;margin-top: -26px;margin-left: 266px;color: #fff;text-decoration: underline;display: none;">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <p class="lahan-minimal">
                                                Lahan minimal <span class="bold"><?= $item->lebar_lahan . ' m x ' . $item->panjang_lahan . ' m' ?></span>
                                            </p>
                                            <p>Biaya konstruksi <span class="bold" data-tootik="Estimasi awal" data-tootik-conf="square">
                                            ...
                                            <div class="product-statistic">
                                                <div class="statistic">
                                                    <button class="btn btn-detail" onclick="detailRumah(<?= $item->id_rumah ?>)">Detail</a> </button>
                                                </div>
                                                <div class="statistic">
                                                    <span class="view">
...
<section class="pb-4 mt-30">
    <div class="container">
        <div class="row banner-slider mobile-favorit" style="background-image: url(<?= base_url('assets/img/dev/BFavorit.jpg') ?>);z-index: 3;">
            <div id="lihat-favorit-mo" style="position: absolute;margin-top: -26px;margin-left: 266px;color: #fff;text-decoration: underline;display: none;"><a href="javascript:void(0)" onclick="lihatFavorit(1)" style="color: #fff;">lihat lainnya</a></div>
...
<section class="pb-4" style="margin-top: 45px;" id="katalog-material-dev">
    ...
    <center><button class="btn btn-detail mt-2" onclick="material()" style="padding: 5px 9px;">Lihat Semua</button></center>
</section>
    ...
    <div class="modal-dialog animated tada" style="z-index: 2;width: 555px;">
        <div class="modal-content" style="background: transparent;box-shadow: none;border: none;">
            <div class="modal-body" style="text-align: center;">
                ...
                <button class="btn btn-danger btn-pop-up btn-konsultasi" onclick="konsultasiDesain()" style="padding: 6px 25px;/*! margin-top: -160px; */font-size: 21px;border-radius: 25px;background: red;border-color: red;box-shadow: 0px 3px 5px 5px rgba(38, 38, 38, 0.19),0px 2px 2px 1px rgba(184, 184, 184, 0.45);position: absolute;bottom: 50px;right: 198px;">Konsultasi</button> <!-- onclick="window.open('https://rumahtinggal.id/desain','_blank')" -->
            </div>
        </div>
    </div>
</div>
                    ...
                    for (var i = 0; i <= 4; i++) {
                        ...
                        $('.katalog-produk .sec-product .list-produk').append(`<div class="col-md-3 col-sm-6 p0 grid">
                            <div class="product-grid" data-id="` + data[i].id_produk + `">
                                ...
                                <div class="product-content">
                                    <div class="title" title="` + data[i].nama_produk + `" onclick="detailProduk(` + data[i].id_produk + `)">` + data[i].nama_produk + `</div>
                                    <div class="product-info">
                                        <div class="suplier" title="` + data[i].nama_suplier + `" onclick="detailSuplier(` + data[i].id_suplier + `)">
                                            <img class="logo" src="<?= $this->config->item('eid') . 'assets/foto/pengguna/' ?>` + data[i].foto_suplier + `">
                                            <span>` + data[i].nama_suplier + `</span>
                                        </div>
                                        <div class="badge" title="` + data[i].merk + `">` + data[i].merk + `</div>
                                    </div>
                                    <div class="product-price">
                                        <div class="price">Rp` + number_format(harga, 0, ',', '.') + `<span class="unit"> / ` + data[i].satuan + `</span></div>
                                    </div>
                                    <div class="product-detail">
                                        <p class="spesification">` + data[i].spesifikasi + `</p>
                                        <div class="product-statistic">
                                            <div class="statistic">
                                                <button class="btn btn-detail produk" onclick="detailProduk(` + data[i].id_produk + `)">Detail</a>
                                            </div>
                                            <div class="statistic">
                                                <button class="btn btn-beli" data-number="` + data[i].no_wa + `" data-id="` + data[i].id_produk + `" data-product="` + data[i].nama_produk + `" data-merk="` + data[i].merk + `" data-spec="` + data[i].spesifikasi + `"><i class="fa fa-shopping-cart" style="margin-top: -1px;"></i> Beli</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
