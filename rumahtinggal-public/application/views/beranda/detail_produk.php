...
.list-material-terkait .product-info .badge {
  line-height: 22px;
}
                            ...
                            <div class="product-grid">
                                <div class="product-image">
                                    <a href="javascript:void(0)" class="image" onclick="detailProduk(<?= $item->id_produk ?>)">
                                        <img class="pic-1" src="<?= $this->config->item('eid').'assets/foto/produk/'.$item->foto ?>">
                                        <img class="pic-2" src="<?= $this->config->item('eid').'assets/foto/produk/'.$item->foto ?>">
                                    </a>
                                </div>
                                <div class="product-content">
                                    ...
                                    <div class="product-info">
                                        <div class="suplier" title="<?= $item->nama_suplier ?>" onclick="detailSuplier(<?= $item->id_suplier ?>)">
                                            <img class="logo" src="<?= $this->config->item('eid').'assets/foto/pengguna/'.$item->foto_suplier ?>">
