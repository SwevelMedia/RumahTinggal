...
<button class="btn btn-danger text-white ml-4" id="cari-desain-mo" onclick="lihatKoleksi()" style="padding: 2px 4px; margin-left: 0px;background: transparent;border-color: transparent; margin-top: 0px;font-size: 13px;position: absolute;top: 10px;left: 244px;font-weight: 600;">Cari Desain</button>
...
function test(){
  ...
  $("#navbarSupportedContent").on("click","li",function(e){
    ...
    // $('#navbarSupportedContent .navbar-nav').addClass("mo-bg");
