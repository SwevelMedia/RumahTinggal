...
.form-wrap form .button {
   ...
   /* background: -moz-linear-gradient(270deg, rgba(105,221,201,1) 0%, rgba(78,193,182,1) 100%);
    ...
    background: linear-gradient(180deg, rgba(105,221,201,1) 0%, rgba(78,193,182,1) 100%);*/
    background-color: #00CED1;
    -webkit-box-shadow: 0px 0px 18px -9px rgba(37, 37, 37, 0.75);
    -moz-box-shadow: 0px 0px 18px -9px rgba(37, 37, 37, 0.75);
    box-shadow: 0px 0px 18px -9px rgba(37, 37, 37, 0.75);
}
.form-wrap form .button:hover {
    background-color: #FFF;
    color: #00ced1;
...
.element.inactive {
  ...
  transform: scale(1) translate3d(0,0,0);
        ...
        <div class="login mt-5" >
            <div class="wrap" style="margin-top: 4em;">
                <!-- TOGGLE -->
                <div id="toggle-wrap">
                    <div id="toggle-terms">
                        <div id="cross">
                ...
                <div class="content">
                    <!-- LOGO -->
                    <!-- <div class="logo">
                        <a href="#"><img src="<?php echo $this->config->item('url_arsi') ?>assets/img/logo.png" alt=""></a>
                    </div> -->
                    <!-- SLIDESHOW -->
                    <div id="slideshow">
                        <div class="one">
                    	...
                    	<div class="tabs-content">
                    		...
                    		<div id="signup-tab-content">
                    			<form class="signup-form">
                    				<input type="text" class="input" id="no_wa" autocomplete="off" placeholder="Masukkan Nomor WhatsApp">
                    			</form>
                              	<button class="button" id="btn-daftar">Daftar</button>
                    			<div class="help-action">
