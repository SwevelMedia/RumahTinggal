...
.kisaran_harga_konstruksi .irs-to { z-index:3; }
...
<section class="mt-5">
    <div class="col-md-12">
        <center>
            <h3 style="font-weight: 400;">Desain Favorit Anda</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 bg-side">
                ...
                <center><button style="padding: 5px 28px;color: #fff;font-size: 15px;" class="btn btn-custom" onclick="temukanDesain()">Mulai</button></center>
                    ...
                    <div class="item-filter">
                        ...
                        <div class="input-group mt-1">
                            <select class="custom-select" name="jum_kamar_tidur" id="jum_kamar_tidur">
                                <option value="1,2,3,4,5">Pilih Semua</option>
                    ...
                    <div class="item-filter">
                        ...
                        <div class="input-group mt-1">
                            <select class="custom-select" name="nama_arsitek" id="inputGroupSelect02">
                                ...
                                <option value="4">BPYstudio</option>
                            </select>
                        </div>
                    </div>
                </div>
