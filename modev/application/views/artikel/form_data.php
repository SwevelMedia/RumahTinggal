            ...
            <div class="middle">
                <div class="text">
                    ...
                    <div style="width: 300px;"> 
                      ...
                      <p><?php echo substr($muka->isi_artikel,0,170) ?>.. <a href="<?= base_url('detail-artikel/'.$muka->id_artikel) ?>">baca selengkapnya..</a></p>
            ...
            <?php foreach($mukaRight as $mukaR) : ?>
                ...
                <div class="col-md-6 col-6 paddding animate-box box" data-animate-effect="fadeIn">
                    ...
                    <div class="middle">
                      ...
                      <p><?php echo substr($mukaR->isi_artikel,0,110) ?>.. <a href="<?= base_url('detail-artikel/'.$mukaR->id_artikel) ?>">baca selengkapnya..</a></p>
...
<script>
 ...
 function katalogArtikel(){
        ...
        $.ajax({
           ...
           type: "POST",
           data: {"cari_artikel" :cari_artikel,"order" :order},
           dataType: "json",
