...
class CustomerController extends CI_Controller
{
...

  {
    ...
    $this->load->library('email', 'google');
  ...
  public function daftarCustomer()
  {
    ...
    if ($cek_customer == 0) {
      ...
      $response = array(
        ...
        'info' => 'E-mail Anda telah terdaftar sebelumya.Silakan login menggunakan akun Anda.'
  ...
  function sendMail($email)
  {
    ...
    //        $mail->Username   = 'windahutari30@gmail.com';
    ...
    //        $mail->setFrom('windahutari30@gmail.com', 'Rumah Tinggal ID');
    ...
    //        // $mailContent = file_get_contents(APPPATH.'views/customer/mail_reset.php'); 
    ...
    //              'Info' => 'Kami telah mengirimkan link untuk reset password. Silakan periksa email Anda dan klik link reset yang tertera.<br><br><b>Info:</b> Jika email tidak terdapat dalam inbox silakan periksa dalam kotak spam.'
...

  {
    ...
    $clientId = '234359626392-3l47fue645tj7m1svcb2565fq1e1o6u6.apps.googleusercontent.com'; //Google client ID lama
    //$clientId = '819505836268-t2kmcb9nufum29hfajk5klltoum2cf8t.apps.googleusercontent.com'; //Google client ID baru (dev)


    $clientSecret = 'qOwxZ1Uq7x4Icm8v1xm4xZVK'; //Google client secret lama
    //$clientSecret = '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'; //Google client secret (dev)
